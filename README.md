...
This section identifies the coding conventions which you must follow when you are writing code for 
this project. These coding conventions are described in the following:

* You must use the `final` keyword when you declare fields, local variables, constructor arguments, or method parameters
  whose value cannot be changed after it has been assigned for the first time. This coding convention must be followed
  when you are writing either production or test code.
