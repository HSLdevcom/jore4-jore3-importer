...
/**
 * Provides methods which allows us to write assertions for the validity period of entities exported
 * to Jore 4 database.
 */
public class ValidityPeriodAssertions {
    ...
    public ValidityPeriodAssertions(
            final SoftAssertions softAssertions, final DateRange validityPeriod) {
        this.softAssertions = softAssertions;
        this.validityPeriod = validityPeriod;
    }

    /**
     * Ensures that the validity period starts at the given date AND the given date is included in
     * the validity period.
     *
     * @param expectedStartDate The expected start date of the validity period.
     */
    public ValidityPeriodAssertions assertThatValidityPeriodStartsAt(
            final LocalDate expectedStartDate) {
        softAssertions
    ...
    /**
     * Ensures that the validity period ends at the given date AND the given date isn't included in
     * the validity period.
     *
     * @param expectedEndDate The expected end date of the validity period.
     */
    public ValidityPeriodAssertions assertThatValidityPeriodEndsAt(
