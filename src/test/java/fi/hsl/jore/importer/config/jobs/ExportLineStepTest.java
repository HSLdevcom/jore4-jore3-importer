...
import fi.hsl.jore.importer.feature.transmodel.repository.TransmodelLineTestRepository;
...
class ExportLineStepTest extends BatchIntegrationTest {
    ...
    private final TransmodelLineTestRepository testRepository;
    ...
    ExportLineStepTest(final @Qualifier("importerDataSource") DataSource importerDataSource,
        ...
        this.testRepository = new TransmodelLineTestRepository(jore4DataSource);
    }
