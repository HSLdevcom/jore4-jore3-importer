...
class ImportScheduledStopPointsStepTest extends BatchIntegrationTest {
    ...
    private static final UUID EXPECTED_INFRASTRUCTURE_NODE_ID =
    ...
    private static final UUID EXPECTED_PLACE_ID =
            UUID.fromString("dfdf8d1d-8649-43bf-9fda-6c23a500a189");
    private static final int EXPECTED_USAGE_IN_ROUTES = 1;

    private static final List<String> STEPS =
            List.of(
                    "prepareScheduledStopPointsStep",
