...
@Sql(
        scripts = {"/sql/jore3/drop_tables.sql", "/sql/jore3/populate_lines.sql", "/sql/jore3/populate_line_headers.sql"
        },
...
public class ImportLineHeadersStepTest extends BatchIntegrationTest {
    ...
    public void whenImportingLinesToEmptyDb_thenInsertsExpectedLine() {
        assertThat(lineHeaderRepository.empty(), is(true));
        ...
        assertThat(header.alive(), is(true));
        assertThat(header.externalId(), is(ExternalId.of("1001-20200603")));
        assertThat(
                header.name(),
        ...
        assertThat(header.validTime(), is(DateRange.between(LocalDate.of(2020, 6, 3), LocalDate.of(2021, 7, 5))));
        assertThat(header.jore4IdOfLine().isEmpty(), is(true));
    }
}
