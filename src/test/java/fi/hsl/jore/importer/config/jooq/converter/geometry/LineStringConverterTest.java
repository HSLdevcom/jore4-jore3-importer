...
public class LineStringConverterTest {
    ...
    public void lineStringXyzToEwktString() {
        ...
        final String expected =
                "SRID=4326;LINESTRING Z(60.16898862 24.949328727 0, 60.168896355 24.945549266 0)";
    ...
    public void lineStringXyToEwktString() {
        ...
        final Object output = CONVERTER.to(line);
        final String expected =
                "SRID=4326;LINESTRING (60.16898862 24.949328727, 60.168896355 24.945549266)";
    ...
    public void pointWkbThrows() {
        ...
        assertThat(exception.getMessage(), is("Unsupported geometry type : Point"));
    }
    ...
    public void ewkbStringToLineString() {
        ...
        assertThat(line.equalsExact(expected), is(true));
    }
}
