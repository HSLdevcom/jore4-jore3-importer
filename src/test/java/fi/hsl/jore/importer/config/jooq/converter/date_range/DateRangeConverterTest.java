...
public class DateRangeConverterTest {
    ...
    public void givenBounded_thenReturnBounded() {
        assertThat(
                ...
                is(DateRange.of(Range.closed(LocalDate.parse("2004-10-19"), LocalDate.parse("2005-10-20")))));
        assertThat(
                CONVERTER.from("(2004-10-19,2005-10-20)"),
                is(DateRange.of(Range.open(LocalDate.parse("2004-10-19"), LocalDate.parse("2005-10-20")))));
        assertThat(
                CONVERTER.from("(\"2004-10-19\",\"2005-10-20\")"),
                is(DateRange.of(Range.open(LocalDate.parse("2004-10-19"), LocalDate.parse("2005-10-20")))));
    }
    ...
    public void givenOnlyTo_thenReturnBounded() {
        assertThat(CONVERTER.from("[,2005-10-19]"), is(DateRange.of(Range.atMost(LocalDate.parse("2005-10-19")))));
        assertThat(CONVERTER.from("(,2005-10-19)"), is(DateRange.of(Range.lessThan(LocalDate.parse("2005-10-19")))));
        assertThat(CONVERTER.from("[,2005-10-19)"), is(DateRange.of(Range.lessThan(LocalDate.parse("2005-10-19")))));
        assertThat(CONVERTER.from("(,2005-10-19]"), is(DateRange.of(Range.atMost(LocalDate.parse("2005-10-19")))));
        assertThat(CONVERTER.from("(,\"2005-10-19\"]"), is(DateRange.of(Range.atMost(LocalDate.parse("2005-10-19")))));
    }
    ...
    public void givenOnlyFrom_thenReturnBounded() {
        assertThat(CONVERTER.from("[2004-10-19,]"), is(DateRange.of(Range.atLeast(LocalDate.parse("2004-10-19")))));
        assertThat(CONVERTER.from("(2004-10-19,)"), is(DateRange.of(Range.greaterThan(LocalDate.parse("2004-10-19")))));
        assertThat(CONVERTER.from("[2004-10-19,)"), is(DateRange.of(Range.atLeast(LocalDate.parse("2004-10-19")))));
        assertThat(CONVERTER.from("(2004-10-19,]"), is(DateRange.of(Range.greaterThan(LocalDate.parse("2004-10-19")))));

        assertThat(CONVERTER.from("[\"2021-01-28\",)"), is(DateRange.of(Range.atLeast(LocalDate.parse("2021-01-28")))));
    }
}
