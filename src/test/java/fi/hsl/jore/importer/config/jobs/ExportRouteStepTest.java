...
public class ExportRouteStepTest extends BatchIntegrationTest {
    ...
    private static final String EXPECTED_DESCRIPTION =
            "{\"fi_FI\":\"Keskustori - Kaleva - Etelä-Hervanta vanha\",\"sv_SE\":\"Central torget -"
                    + " Kaleva - Södra Hervanta gamla\"}";
    ...
    private static final fi.hsl.jore.importer.jooq.network.tables.NetworkRouteDirections
    ...
    public ExportRouteStepTest(
        ...
        this.importerTargetTable =
                new Table(importerDataSource, "network.network_route_directions");
        this.jore4TargetTable = new Table(jore4DataSource, "route.route");
        this.testRepository =
                new Jore4ValidityPeriodTestRepository(
                        jore4DataSource, ValidityPeriodTargetTable.ROUTE);
    }
    ...
    @Test
    @DisplayName(
            "Should update the Jore 4 id of the route direction found from the importer's database")
