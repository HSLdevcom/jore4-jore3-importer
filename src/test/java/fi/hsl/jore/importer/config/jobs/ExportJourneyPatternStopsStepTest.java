...
public class ExportJourneyPatternStopsStepTest extends BatchIntegrationTest {
    ...
    private static final String EXPECTED_JOURNEY_PATTERN_ID =
            "ec564137-f30c-4689-9322-4ef650768af3";
    ...
    private static final Map<String, String> EXPECTED_SECOND_VIA_POINT_NAMES =
    ...
    ExportJourneyPatternStopsStepTest(
        ...
        this.targetTable =
                new Table(
                        jore4DataSource, "journey_pattern.scheduled_stop_point_in_journey_pattern");
    ...
    @Test
    @DisplayName(
            "Should insert the correct information of the first journey pattern stop into the Jore"
                    + " 4 database")
    ...
    @Test
    @DisplayName(
            "Should insert the correct information of the second journey pattern stop into the Jore"
                    + " 4 database")
    void shouldInsertCorrectInformationOfSecondJourneyPatternStopIntoJore4Database() {
        ...
        softAssertions
                ...
                .as("viaPointName")
                .satisfies(
                        new Condition<PGobject>(
                                pgObject -> {
                                    final String jsonbAsString = pgObject.getValue();

                                    // Assert that conversion from PostgreSQL JSONB data type to a
                                    // hash map
    ...
    @Test
    @DisplayName(
            "Should insert the correct information of the third journey pattern stop into the Jore"
                    + " 4 database")
