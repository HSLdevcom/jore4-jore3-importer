...
public class ExportRouteGeometriesStepTest extends BatchIntegrationTest {
    ...
    private static final UUID EXPECTED_INFRASTRUCTURE_LINK_ID =
    ...
    @Autowired
    public ExportRouteGeometriesStepTest(
    ...
    @Test
    @DisplayName(
            "Should save a new route infrastructure link with the correct infrastructure link id")
    ...
    @Test
    @DisplayName(
            "Should save a new route infrastructure link with the correct infrastructure link"
                    + " sequence")
