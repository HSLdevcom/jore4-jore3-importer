...
public class TimeRangeConverterTest {
    ...
    public void givenOnlyTo_thenReturnBounded() {
        assertThat(
                CONVERTER.from(String.format("[,%s]", PG_STRING_END)),
    ...
    public void givenMissingTimezone_thenThrows() {
        assertThrows(
                ...
                () -> CONVERTER.from(String.format("[%s,)", "2004-10-19 10:23:54")));
    }
    ...
    public void givenMissingTime_thenThrows() {
        assertThrows(
                DateTimeParseException.class,
                () -> CONVERTER.from(String.format("[%s,)", "2004-10-19")));
    }
    ...
    public void givenMissingDate_thenThrows() {
        assertThrows(
                DateTimeParseException.class,
                () -> CONVERTER.from(String.format("[%s,)", "10:23:54+02")));
    }
}
