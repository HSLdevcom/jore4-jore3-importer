...
public class ExportJourneyPatternsStepTest extends BatchIntegrationTest {
    ...
    private static final UUID EXPECTED_ROUTE_ID =
    ...
    private static final fi.hsl.jore.importer.jooq.network.tables.NetworkRouteDirections
            IMPORTER_ROUTE_DIRECTIONS =
                    fi.hsl.jore.importer.jooq.network.Tables.NETWORK_ROUTE_DIRECTIONS;
    private static final fi.hsl.jore.jore4.jooq.journey_pattern.tables.JourneyPattern
            JORE4_JOURNEY_PATTERN = fi.hsl.jore.jore4.jooq.journey_pattern.Tables.JOURNEY_PATTERN_;
    ...
    @Test
    @DisplayName(
            "Should update the journey pattern Jore 4 id of a route found from the importer's"
                    + " database")
