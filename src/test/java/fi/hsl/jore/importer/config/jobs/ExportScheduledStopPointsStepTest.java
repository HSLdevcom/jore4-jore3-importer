...
class ExportScheduledStopPointsStepTest extends BatchIntegrationTest {
    ...
    private static final TransmodelScheduledStopPointDirection DIRECTION_ON_INFRALINK = TransmodelScheduledStopPointDirection.BACKWARD;
    ...
    @Autowired
    ExportScheduledStopPointsStepTest(@Qualifier("jore4DataSource") DataSource targetDataSource) {
