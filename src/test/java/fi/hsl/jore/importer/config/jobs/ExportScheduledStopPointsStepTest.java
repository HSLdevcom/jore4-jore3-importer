...
import fi.hsl.jore.importer.feature.transmodel.repository.TransmodelScheduledStopPointTestRepository;
...
class ExportScheduledStopPointsStepTest extends BatchIntegrationTest {
    ...
    private final TransmodelScheduledStopPointTestRepository testRepository;
    ...
    ExportScheduledStopPointsStepTest(final @Qualifier("importerDataSource") DataSource importerDataSource,
        ...
        this.testRepository = new TransmodelScheduledStopPointTestRepository(jore4DataSource);
    }
