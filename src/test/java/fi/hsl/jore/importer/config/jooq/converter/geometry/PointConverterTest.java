...
public class PointConverterTest {
    ...
    public void pointXYZToWktString() {
        final Point point =
                GeometryUtil.toPoint(GeometryUtil.SRID_WGS84, new Coordinate(60.168988620, 24.949328727, 0));

        final Object output = CONVERTER.to(point);
    ...
    public void pointXYToWktString() {
        final Point point = GeometryUtil.toPoint(GeometryUtil.SRID_WGS84, new Coordinate(60.168988620, 24.949328727));
    ...
    public void lineStringWkbThrows() {
        ...
        assertThat(exception.getMessage(), is("Unsupported geometry type : LineString"));
    }
    ...
    public void wkbStringToPoint() {
        ...
        assertThat(point.equalsExact(expected), is(true));
    }
}
