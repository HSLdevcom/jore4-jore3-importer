...
public class LinkRepositoryTest extends IntegrationTest {
    ...
    public void beforeEach() {
        assertThat(
                "Node repository should be empty at the start of the test",
                nodeRepository.empty(),
                is(true));
        assertThat(
                "Link repository should be empty at the start of the test",
    ...
    public void insertMultipleLinks() {
        ...
        final List<LinkPK> keys =
                linkRepository.insert(
                        PersistableLink.of(
                                ExternalId.of("a"), NetworkType.ROAD, GEOM, startNode, endNode),
                        PersistableLink.of(
                                ExternalId.of("b"), NetworkType.ROAD, GEOM2, startNode, endNode));
