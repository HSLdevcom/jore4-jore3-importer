...
public class SystemTimeTest extends IntegrationTest {
    ...
    public void testSystemTimeAfterInsert() {
        ...
        assertThat(
                "Sanity check: inserting the entity was not instantaneous", after.isAfter(before));
        ...
        assertThat(
                "Only one (alive) entity should exist (including history) ",
        ...
        assertThat(
                "Entity system time should have a starting point (= last modified or creation"
                        + " time)",
        ...
        assertThat(
                ...
                is(false));
        assertThat(
                "Entity system time should not contain timestamps before the entity was"
                        + " created/modified",
    ...
    public void testSystemTimeAfterUpdate() {
        ...
        assertThat(
                "History should contain the latest version and the two earlier ones",
                allEntities.size(),
                is(3));
        ...
        assertThat(
                "Current entity system time should not have an end point (as it's not yet"
                        + " deleted/modified)",
