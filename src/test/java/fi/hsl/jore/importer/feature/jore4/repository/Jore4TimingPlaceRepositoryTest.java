...
public class Jore4TimingPlaceRepositoryTest {
    ...
    private static final UUID TIMING_PLACE_ID =
            UUID.fromString("b5f56d68-c4cf-11ed-afa1-0242ac120002");
    private static final String TIMING_PLACE_LABEL = "1ELIEL";
    private static final String TIMING_PLACE_NAME = "Elielinaukio";

    private static final String EXPECTED_RESULTING_TIMING_PLACE_NAME =
            "{\"fi_FI\":\"" + TIMING_PLACE_NAME + "\"}";
