...
public class JobControllerTest {
    ...
    public JobControllerTest(
            @Autowired final MockMvc mockMvc, @Autowired final ObjectMapper objectMapper) {
    ...
    public void whenJobRun_thenReturnLastStatus() throws Exception {
        ...
        final MvcResult result =
                mockMvc.perform(get("/job/import/status")).andExpect(status().isOk()).andReturn();
        ...
        assertThat(
                ...
                is(
                        ImmutableJobStatus.builder()
                                ...
                                .endTime(endTime)
                                .exitDescription(
                                        "java.lang.RuntimeException: Guru mediation error!")
                                .build()));
    }
    ...
    public void whenStartingJob_thenReturnInitialStatus() throws Exception {
        ...
        final MvcResult result =
                mockMvc.perform(post("/job/import/start")).andExpect(status().isOk()).andReturn();
