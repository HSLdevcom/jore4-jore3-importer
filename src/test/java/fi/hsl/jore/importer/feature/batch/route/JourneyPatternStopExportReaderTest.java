...
class JourneyPatternStopExportReaderTest {
    ...
    class WhenSourceTableHasOneRouteWithTwoStops {
        ...
        private static final boolean SECOND_JOURNEY_PATTERN_STOP_IS_HASTUS_POINT = false;
        private static final boolean SECOND_JOURNEY_PATTERN_STOP_IS_VIA_POINT = false;
