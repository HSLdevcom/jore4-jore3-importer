...
class LineExportReaderTest {
    ...
    class WhenSourceTablesHaveOneLine {
        ...
        void firstInvocationOfReadMethodMustReturnFoundLine(final SoftAssertions softAssertions)
                throws Exception {
