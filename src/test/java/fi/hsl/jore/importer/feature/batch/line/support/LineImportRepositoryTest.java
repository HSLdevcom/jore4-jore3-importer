...
public class LineImportRepositoryTest {
    ...
    class SetTransmodelIds {
        ...
        class WhenLineIsNotFound {
            ...
            private final String UNKNOWN_EXT_ID = "999999999";
            private final List<PersistableLineTransmodelId> INPUT = List.of(
                    PersistableLineTransmodelId.of(UNKNOWN_EXT_ID, TRANSMODEL_ID)
            );
        ...
        class WhenLineIsFound {
            ...
            private final List<PersistableLineTransmodelId> INPUT = List.of(
                    PersistableLineTransmodelId.of(EXT_ID.value(), TRANSMODEL_ID)
            );
