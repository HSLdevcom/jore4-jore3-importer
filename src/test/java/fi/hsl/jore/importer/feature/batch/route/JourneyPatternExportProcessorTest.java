...
class JourneyPatternExportProcessorTest {
    ...
    private static final UUID ROUTE_DIRECTION_EXT_ID =
            UUID.fromString("a6fb1824-0cdc-49cf-bd43-7e931ffd249a");
    private static final UUID ROUTE_ID = UUID.fromString("5bfa9a65-c80f-4af8-be95-8370cb12df50");
    private static final ImporterJourneyPattern INPUT =
            ImporterJourneyPattern.of(ROUTE_DIRECTION_EXT_ID, ROUTE_ID);
