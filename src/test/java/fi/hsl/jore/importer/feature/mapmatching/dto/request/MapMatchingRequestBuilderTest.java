...
import fi.hsl.jore.importer.feature.mapmatching.dto.request.RoutePointRequestDTO;
...
public class MapMatchingRequestBuilderTest {
    ...
    class CreateMapMatchingRequest {
        ...
        void shouldReturnMapMatchingRequestWithCorrectRouteId() {
            ...
            assertThat(request.getRouteId()).isEqualTo(ROUTE_DIRECTION_ID.toString());
        }
        ...
        void shouldReturnMapMatchingRequestWithCorrectRouteGeometry(final SoftAssertions softAssertions) {
            ...
            final RouteGeometryRequestDTO routeGeometry = request.getRouteGeometry();

            softAssertions.assertThat(routeGeometry.getCoordinates()).hasSize(2);

            final double[] startPoint = routeGeometry.getCoordinates().get(0);
            softAssertions.assertThat(startPoint[0])
                    .as("startPointX")
                    .isEqualTo(ROUTE_GEOMETRY_START_X);
            softAssertions.assertThat(startPoint[1])
                    .as("startPointY")
                    .isEqualTo(ROUTE_GEOMETRY_START_Y);

            final double[] endPoint = routeGeometry.getCoordinates().get(1);
            softAssertions.assertThat(endPoint[0])
                    .as("endPointX")
                    .isEqualTo(ROUTE_GEOMETRY_END_X);
            softAssertions.assertThat(endPoint[1])
                    .as("endPointY")
        ...
        class WhenInputRoutePointIsCrossRoad {
            ...
            void shouldReturnMapMatchingRequestWithCorrectRoutePoint(SoftAssertions softAssertions) {
                ...
                final RoutePointLocationRequestDTO routePointLocation = routePoint.getLocation();
                final double[] routePointCoordinates = routePointLocation.getCoordinates();
                softAssertions.assertThat(routePointCoordinates[0])
                        .as("routePointX")
                        .isEqualTo(ROUTE_POINT_X);
                softAssertions.assertThat(routePointCoordinates[1])
                        .as("routePointY")
        ...
        class WhenInputRoutePointIsScheduledStopPoint {
            ...
            private static final String ELY_NUMBER = "123567";
            ...
            void shouldReturnMapMatchingRequestWithCorrectRoutePoint(final SoftAssertions softAssertions) {
                ...
                final RoutePointLocationRequestDTO routePointProjectedLocation = routePoint.getProjectedLocation();
                final double[] routePointProjectedCoordinates = routePointProjectedLocation.getCoordinates();
                softAssertions.assertThat(routePointProjectedCoordinates[0])
                        .as("routePointProjectedX")
                        .isEqualTo(ROUTE_PROJECTED_POINT_X);
                softAssertions.assertThat(routePointProjectedCoordinates[1])
