...
public class TimingPlaceExportReaderTest {
    ...
    class WhenSourceTableIsNotEmpty {
        ...
        @Test
        @DisplayName(
                "The first invocation of the read() method must return the first timing place label"
        ...
        @Test
        @DisplayName(
                "The second invocation of the read() method must return the second timing place"
