...
public class RouteLinksProcessorTest {
    ...
    public void givenLinkBetweenTwoBusStops_thenReturnRoutePoints_andStopPoints() throws Exception {
        ...
        final RouteLinksAndAttributes linksAndAttributes =
                RouteLinksAndAttributes.of(
                        Vector.of(link),
                        LastLinkAttributes.of(NodeType.BUS_STOP, true, Optional.of(7)));
    ...
    public void givenLinkBetweenABusStopAndACrossroad_thenReturnRoutePoints_andSingleStopPoint() {
        // (A pathological) route consists of a single link between a bus stop and a crossroad
        // junction
        final JrRouteLink link =
                JrRouteLink.of(
                        RouteLinkId.of(1234),
        ...
        final RouteLinksAndAttributes linksAndAttributes =
                RouteLinksAndAttributes.of(
                        Vector.of(link),
                        LastLinkAttributes.of(NodeType.CROSSROADS, false, Optional.empty()));
    ...
    public void givenLinkWithNoBusStops_thenReturnRoutePoints_andNoStopPoints() throws Exception {
        ...
        assertThat(
                "There are no bus stops in this route => no stop points",
                stopPoints.isEmpty(),
                is(true));
    }
    ...
    public void givenComplexRoute_thenReturnRoutePoints_andStopPoints() throws Exception {
        ...
        final Vector<JrRouteLink> links =
                Vector.of(
                        // A->B
                        JrRouteLink.of(
                        ...
                        JrRouteLink.of(
                                ...
                                Optional.of(VIA_NAME),
                                Optional.of(VIA_NAME_SWEDISH),
                                Optional.empty()), // The column number isn't given because link
                        // isn't included in timetable
                        // C->D
                        JrRouteLink.of(
        ...
        final RouteLinksAndAttributes linksAndAttributes =
                RouteLinksAndAttributes.of(links, attributes);
                ...
                is(
                        Vector.of(
                                ...
                                ImmutableJore3RoutePoint.builder()
                                        ...
                                        .routeDirection(ExternalId.of("1001-1-20200101"))
                                        .build(),
                                // Note how the last route point "borrows" the link id from the
                                // final link
                                ImmutableJore3RoutePoint.builder()
                                        .orderNumber(6)
