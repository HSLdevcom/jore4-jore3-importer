...
public class PlaceImportRepositoryTest {
    ...
    public PlaceImportRepositoryTest(@Autowired final IPlaceImportRepository importRepository,
    ...
    class CommitStagingToTarget {
        ...
        public void whenNewStagedRowsAndCommit_andTargetDbEmpty_thenReturnResultWithInsertedId() {
            importRepository.submitToStaging(
                    List.of(PersistablePlace.of(EXT_ID, PLACE_NAME))
            );
            ...
            assertThat("The inserted row is found in the target repository",
                    maybePlace.isPresent(),
                    is(true));
        }

        @Test
        public void whenNoStagedRowsAndCommit_andTargetNotEmpty_thenReturnResultWithDeletedId() {
            final PlacePK existingId = targetRepository.insert(
                    PersistablePlace.of(EXT_ID, PLACE_NAME)
            );
        ...
        public void whenNewStagedRowsAndCommit_andTargetNotEmpty_thenReturnResultWithUpdatedId() {
            ...
            importRepository.submitToStaging(
                    List.of(PersistablePlace.of(EXT_ID, PLACE_NEW_NAME))
            );
            ...
            assertThat("Target repository including history should contain two rows",
                    targetRepository.countHistory(),
                    is(2));
            ...
            assertThat("The name of updated row should be changed as expected in the target repository",
                    maybePlace.get().name(),
                    is(PLACE_NEW_NAME));
        }
    }
