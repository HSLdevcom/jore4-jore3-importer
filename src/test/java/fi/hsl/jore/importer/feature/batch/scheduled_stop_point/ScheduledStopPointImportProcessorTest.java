...
class ScheduledStopPointImportProcessorTest {
    ...
    private final ScheduledStopPointImportProcessor processor =
            new ScheduledStopPointImportProcessor();

    @Nested
    @DisplayName("Process")
    class Process {

        private final JrScheduledStopPoint input =
                JrScheduledStopPoint.of(
        ...
        void shouldReturnScheduledStopPointWithCorrectFinnishName() throws Exception {
            ...
            final String finnishName =
                    JoreLocaleUtil.getI18nString(returned.name(), JoreLocaleUtil.FINNISH);
        ...
        void shouldReturnScheduledStopPointWithCorrectSwedishName() throws Exception {
            ...
            final String swedishName =
                    JoreLocaleUtil.getI18nString(returned.name(), JoreLocaleUtil.SWEDISH);
