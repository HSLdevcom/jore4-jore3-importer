...
class RouteDirectionImportRepositoryTest {
        ...
        class WhenStagingTableHasRows {
            ...
            class WhenTargetTableIsEmpty {
                ...
                void shouldInsertNewRouteDirectionToTargetTable(SoftAssertions softAssertions) {
                    ...
                    final String actualFinnishNameShort =
                            JoreLocaleUtil.getI18nString(inserted.nameShort(), JoreLocaleUtil.FINNISH);
                    softAssertions
                    ...
                    final String actualSwedishNameShort =
                            JoreLocaleUtil.getI18nString(inserted.nameShort(), JoreLocaleUtil.SWEDISH);
                    softAssertions
                    ...
                    final String actualFinnishDestination =
                            JoreLocaleUtil.getI18nString(inserted.destination(), JoreLocaleUtil.FINNISH);
                    softAssertions
                    ...
                    final String actualSwedishDestination =
                            JoreLocaleUtil.getI18nString(inserted.destination(), JoreLocaleUtil.SWEDISH);
                    softAssertions
            ...
            class WhenTargetTableContainsImportedRouteDirection {
                ...
                void shouldUpdateInformationOfRouteDirectionFoundFromTargetTable(SoftAssertions softAssertions) {
                    ...
                    final RouteDirection updated = targetRepository
                            .findById(RouteDirectionPK.of(EXPECTED_NETWORK_ROUTE_DIRECTION_ID))
                            .get();
                    ...
                    final String actualFinnishNameShort =
                            JoreLocaleUtil.getI18nString(updated.nameShort(), JoreLocaleUtil.FINNISH);
                    softAssertions
                            .assertThat(actualFinnishNameShort)
                            .overridingErrorMessage(
                                    "Expected the Finnish short name to be: %s but was: %s",
                    ...
                    final String actualSwedishNameShort =
                            JoreLocaleUtil.getI18nString(updated.nameShort(), JoreLocaleUtil.SWEDISH);
                    softAssertions
                            .assertThat(actualSwedishNameShort)
                            .overridingErrorMessage(
                                    "Expected the Swedish short name to be: %s but was: %s",
                    ...
                    final String actualFinnishDestination =
                            JoreLocaleUtil.getI18nString(updated.destination(), JoreLocaleUtil.FINNISH);
                    softAssertions
                            .assertThat(actualFinnishDestination)
                            .overridingErrorMessage(
                                    "Expected the Finnish destination to be: %s but was: %s",
                    ...
                    final String actualSwedishDestination =
                            JoreLocaleUtil.getI18nString(updated.destination(), JoreLocaleUtil.SWEDISH);
                    softAssertions
                            .assertThat(actualSwedishDestination)
                            .overridingErrorMessage(
                                    "Expected the Swedish destination to be: %s but was: %s",
    ...
    class SetJourneyPatternJore4Ids {
        ...
        class WhenRouteDirectionIsNotFound {
            ...
            private final List<PersistableJourneyPatternIdMapping> INPUT = List.of(
                    PersistableJourneyPatternIdMapping.of(UNKNOWN_ROUTE_DIRECTION_ID, JOURNEY_PATTERN_JORE4_ID));
            ...
            void shouldNotUpdateJourneyPatternIdOfExistingRouteDirection() {
                ...
                final RouteDirection routeDirection = targetRepository
                        .findById(RouteDirectionPK.of(ROUTE_DIRECTION_ID))
                        .get();
        ...
        class WhenRouteDirectionIsFound {
            ...
            private final List<PersistableJourneyPatternIdMapping> INPUT =
                    List.of(PersistableJourneyPatternIdMapping.of(ROUTE_DIRECTION_ID, JOURNEY_PATTERN_JORE4_ID));
