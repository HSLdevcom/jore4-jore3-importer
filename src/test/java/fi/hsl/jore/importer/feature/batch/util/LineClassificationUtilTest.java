    ...
    class FromNodeType {
        ...
        void shouldReturnCorrectRoutePointType(
            ...
            final TypeOfLine actual =
                    LineClassificationUtil.resolveTypeOfLine(transitType, isTrunkLine, publicTransportType, lineNumber);
    ...
    private static class LineClassificationUtilArgumentsProvider implements ArgumentsProvider {
        ...
        public Stream<? extends Arguments> provideArguments(final ExtensionContext extensionContext) {
            return Stream.of(
                    ...
                    Arguments.of(
                            TransitType.BUS, false, PublicTransportType.BUS_LOCAL, "123", TypeOfLine.SPECIAL_NEEDS_BUS),
                    Arguments.of(
                            TransitType.BUS,
                            false,
                    ...
                    Arguments.of(
                            TransitType.FERRY, true, PublicTransportType.OTHER_LOCAL, "456", TypeOfLine.FERRY_SERVICE),
                    Arguments.of(
                            TransitType.SUBWAY,
                            false,
                            PublicTransportType.HELSINKI_EARLY_MORNING,
                    ...
                    Arguments.of(
                            TransitType.SUBWAY, true, PublicTransportType.OTHER_LOCAL, "156", TypeOfLine.METRO_SERVICE),
                    Arguments.of(
                            TransitType.TRAM,
                            false,
                            PublicTransportType.ESPOO_SERVICE,
