...
public class TransitTypeToNetworkTypeMapperTest {
    ...
    public void testEachTransitTypeSupported() {
        assertThat(TransitTypeToNetworkTypeMapper.TO_NETWORK_TYPE.keySet(), is(HashSet.of(TransitType.values())));
    }
    ...
    public void testEachNetworkTypeSupported() {
        ...
        assertThat(
                TransitTypeToNetworkTypeMapper.TO_NETWORK_TYPE.values().toSet(), is(HashSet.of(NetworkType.values())));
    }
}
