...
class RouteExportProcessorTest {
    ...
    private static final UUID IMPORTER_ROUTE_DIRECTION_ID =
            UUID.fromString("2d28fda6-b497-436e-8093-c049a9bd7769");
    ...
    private static final UUID JORE4_ID_OF_LINE =
            UUID.fromString("184b4710-9366-4500-aef3-39d03e95dde2");
    ...
    private static final ImporterRoute INPUT =
            ImporterRoute.of(
                    ROUTE_NUMBER,
    ...
    void shouldReturnRouteWithCorrectFinnishName() throws Exception {
        ...
        final String finnishName =
                JoreLocaleUtil.getI18nString(route.description(), JoreLocaleUtil.FINNISH);
    ...
    void shouldReturnRouteWithCorrectSwedishName() throws Exception {
        ...
        final String swedishName =
                JoreLocaleUtil.getI18nString(route.description(), JoreLocaleUtil.SWEDISH);
