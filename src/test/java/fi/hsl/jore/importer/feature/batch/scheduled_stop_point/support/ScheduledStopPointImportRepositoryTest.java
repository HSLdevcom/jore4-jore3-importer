...
public class ScheduledStopPointImportRepositoryTest {
    ...
    class SetTransmodelIds {
        ...
        class WhenUpdatedScheduledStopPointIsNotFound {
            ...
            private List<PersistableScheduledStopPointTransmodelId> INPUT = List.of(
                    PersistableScheduledStopPointTransmodelId.of(UNKNOWN_EXT_ID, TRANSMODEL_ID)
            );
        ...
        class WhenUpdatedScheduledStopPointIsFound {
            ...
            private List<PersistableScheduledStopPointTransmodelId> INPUT = List.of(
                    PersistableScheduledStopPointTransmodelId.of(EXTERNAL_ID, TRANSMODEL_ID)
            );
