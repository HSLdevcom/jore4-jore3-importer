...
public class ScheduledStopPointImportRepositoryTest {
    ...
    @Autowired
    ScheduledStopPointImportRepositoryTest(
            final IScheduledStopPointImportRepository importRepository,
    ...
    class CommitStagingToTarget {
        ...
        private final UUID EXPECTED_INFRASTRUCTURE_NODE_ID =
                UUID.fromString("cc11a5db-2ae7-4220-adfe-aca5d6620909");
        ...
        private final UUID EXPECTED_PLACE_ID =
                UUID.fromString("26458311-99f7-401b-a0a1-0671a7df17bb");
        ...
        class WhenStagingTableHasNoRows {
            ...
            class WhenTargetTableHasOneRow {
                ...
                void shouldDeleteExistingRowFromTargetTable(final SoftAssertions softAssertions) {
                    final Map<RowStatus, Set<ScheduledStopPointPK>> result =
        ...
        class WhenStagingTableHasRows {
            ...
            class WhenTargetTableIsEmpty {
                ...
                void shouldInsertNewScheduledStopPointIntoTargetTable(
                    ...
                    softAssertions
                            .assertThat(inserted.shortId())
                            .as("shortId")
                            .contains(EXPECTED_SHORT_ID);

                    softAssertions
                            .assertThat(inserted.placeId())
                            .as("placeId")
            ...
            class WhenTargetTableContainsImportedScheduledStopPoint {
                ...
                void shouldUpdateInformationOFoundScheduledStopPoint(
                        final SoftAssertions softAssertions) {
                    importRepository.commitStagingToTarget();
                    final ScheduledStopPoint updated =
                            targetRepository.findById(ScheduledStopPointPK.of(EXPECTED_ID)).get();

                    softAssertions.assertThat(updated.pk().value()).as("id").isEqualTo(EXPECTED_ID);
                    ...
                    softAssertions
                            .assertThat(updated.shortId())
                            .as("shortId")
                            .contains(EXPECTED_SHORT_ID);

                    softAssertions
                            .assertThat(updated.placeId())
                            .as("placeId")
                            .contains(EXPECTED_PLACE_ID);
                }
            }
    ...
    class SetJore4Ids {
        ...
        class WhenUpdatedScheduledStopPointIsNotFound {
            ...
            private List<PersistableScheduledStopPointIdMapping> INPUT =
                    List.of(PersistableScheduledStopPointIdMapping.of(UNKNOWN_EXT_ID, JORE4_ID));
            ...
            void shouldNotUpdateJore4IdOfExistingScheduledStopPoint() {
                ...
                final ScheduledStopPoint updated =
                        targetRepository.findByExternalId(ExternalId.of(EXTERNAL_ID)).get();
        ...
        class WhenUpdatedScheduledStopPointIsFound {
            ...
            private final List<PersistableScheduledStopPointIdMapping> INPUT =
                    List.of(PersistableScheduledStopPointIdMapping.of(EXTERNAL_ID, JORE4_ID));
