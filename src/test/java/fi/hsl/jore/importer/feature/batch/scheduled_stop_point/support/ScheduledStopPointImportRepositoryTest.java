        ...
        class WhenStagingTableHasRows {
            ...
            class WhenTargetTableIsEmpty {
                ...
                void shouldInsertNewScheduledStopPointIntoTargetTable(final SoftAssertions softAssertions) {
                    ...
                    softAssertions.assertThat(inserted.shortId()).as("shortId").contains(EXPECTED_SHORT_ID);

                    softAssertions.assertThat(inserted.placeId()).as("placeId").contains(EXPECTED_PLACE_ID);
                }
            }
            ...
            class WhenTargetTableContainsImportedScheduledStopPoint {
                ...
                void shouldUpdateInformationOFoundScheduledStopPoint(final SoftAssertions softAssertions) {
                    ...
                    final ScheduledStopPoint updated = targetRepository
                            .findById(ScheduledStopPointPK.of(EXPECTED_ID))
                            .get();
                    ...
                    softAssertions.assertThat(updated.shortId()).as("shortId").contains(EXPECTED_SHORT_ID);

                    softAssertions.assertThat(updated.placeId()).as("placeId").contains(EXPECTED_PLACE_ID);
                }
            }
        }
    }
    ...
    class SetJore4Ids {
        ...
        class WhenUpdatedScheduledStopPointIsNotFound {
            ...
            void shouldNotUpdateJore4IdOfExistingScheduledStopPoint() {
                ...
                final ScheduledStopPoint updated = targetRepository
                        .findByExternalId(ExternalId.of(EXTERNAL_ID))
                        .get();
