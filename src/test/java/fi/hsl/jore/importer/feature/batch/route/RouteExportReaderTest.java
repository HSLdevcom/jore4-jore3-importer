...
class RouteExportReaderTest {
    ...
    class WhenSourceTableHasOneRoute {
        ...
        private final UUID EXPECTED_DIRECTION_ID =
        ...
        private final UUID EXPECTED_JORE4_ID_OF_LINE =
                UUID.fromString("5aa7d9fc-2cf9-466d-8ac0-f442d60c261f");
        private static final String EXPECTED_ROUTE_NUMBER = "1";
        private static final String EXPECTED_FINNISH_NAME =
                "Keskustori - Kaleva - Etelä-Hervanta vanha";
        private static final String EXPECTED_SWEDISH_NAME =
                "Central torget - Kaleva - Södra Hervanta gamla";
        ...
        void firstInvocationOfReadMethodMustReturnFoundRoute(final SoftAssertions softAssertions)
                throws Exception {
            final ImporterRoute route = reader.read();

            softAssertions
                    .assertThat(route.directionId())
                    .as("directionId")
                    .isEqualTo(EXPECTED_DIRECTION_ID);
            softAssertions
                    .assertThat(route.directionType())
                    .as("directionType")
                    .isEqualTo(EXPECTED_DIRECTION_TYPE);
            softAssertions
                    .assertThat(route.jore4IdOfLine())
                    .as("jore4IdOfLine")
            ...
            final String finnishName =
                    JoreLocaleUtil.getI18nString(route.name(), JoreLocaleUtil.FINNISH);
            softAssertions
            ...
            final String swedishName =
                    JoreLocaleUtil.getI18nString(route.name(), JoreLocaleUtil.SWEDISH);
            softAssertions
