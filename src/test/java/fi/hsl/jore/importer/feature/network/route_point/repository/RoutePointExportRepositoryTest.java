...
class RoutePointExportRepositoryTest {
    ...
    class FindImporterRoutePointsByRouteDirectionId {
        ...
        class WhenSourceTablesHaveOneRouteWithThreeRoutePoints {
            ...
            void shouldReturnCorrectInformationOfFirstRoutePoint(
                    final SoftAssertions softAssertions) {
                final ImporterRoutePoint firstRoutePoint =
                        repository
                ...
                softAssertions
                        .assertThat(firstRoutePoint.type())
                        .as("type")
            ...
            void shouldReturnCorrectInformationOfSecondRoutePoint(
                    final SoftAssertions softAssertions) {
                final ImporterRoutePoint secondRoutePoint =
                        repository
                                .findImporterRoutePointsByRouteDirectionId(ROUTE_DIRECTION_ID)
                                .get(1);
                ...
                softAssertions
                        .assertThat(secondRoutePoint.type())
                        .as("type")
            ...
            void shouldReturnCorrectInformationOfThirdRoutePoint(
                    final SoftAssertions softAssertions) {
                final ImporterRoutePoint thirdRoutePoint =
                        repository
                                .findImporterRoutePointsByRouteDirectionId(ROUTE_DIRECTION_ID)
                                .get(2);
                ...
                softAssertions
                        .assertThat(thirdRoutePoint.type())
                        .as("type")
