...
import fi.hsl.jore.importer.feature.network.route_point.repository.RoutePointExportRepository;
...
class RouteGeometryExportProcessorTest {
    ...
    private RouteGeometryExportProcessor processor;
    ...
    void configureSystemUnderTest() {
        ...
        processor = new RouteGeometryExportProcessor(mapMatchingService, repository);
