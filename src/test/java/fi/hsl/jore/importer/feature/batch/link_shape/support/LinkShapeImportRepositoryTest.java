...
public class LinkShapeImportRepositoryTest extends IntegrationTest {
    ...
    @Test
    public void
            whenStagedRowsAndCommit_andTargetLinkHasNoPoints_thenReturnResultWithUpdatedShape() {
    ...
    public void whenStagedRowsAndCommit_andTargetLinkHasPoints_thenReturnResultWithUpdatedShape() {
        ...
        targetRepository.insert(
                PersistableLinkShape.of(parentLink.pk(), parentLink.externalId(), LINEPOINTS_1));
