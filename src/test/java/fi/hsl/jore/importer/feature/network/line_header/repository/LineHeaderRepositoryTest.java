...
public class LineHeaderRepositoryTest extends IntegrationTest {
    ...
    private static final MultilingualString NAME = MultilingualString.empty().with(Locale.ENGLISH, "name");
    ...
    private static final DateRange VALID_TIME = DateRange.between(LocalDate.of(2020, 5, 6), LocalDate.of(2021, 6, 25));
