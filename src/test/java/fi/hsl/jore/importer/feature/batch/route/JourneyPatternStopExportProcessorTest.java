...
class JourneyPatternStopExportProcessorTest {
    ...
    private static final Map<String, String> VIA_POINT_NAME_MAP = Map.of(JoreLocaleUtil.FINNISH.toString(), "ViaSuomi", JoreLocaleUtil.SWEDISH.toString(), "ViaSverige");
    private static final Optional<MultilingualString> VIA_POINT_NAMES = Optional.of(MultilingualString.of(VIA_POINT_NAME_MAP));
    ...
    void shouldReturnJourneyPatternStopWithCorrectViaPointNames() throws Exception {
        ...
        assertThat(finnishName).isEqualTo(VIA_POINT_NAME_MAP.get(JoreLocaleUtil.FINNISH.toString()));
        final String swedishName = JoreLocaleUtil.getI18nString(output.viaPointNames().get(), JoreLocaleUtil.SWEDISH);
        assertThat(swedishName).isEqualTo(VIA_POINT_NAME_MAP.get(JoreLocaleUtil.SWEDISH.toString()));
    }
