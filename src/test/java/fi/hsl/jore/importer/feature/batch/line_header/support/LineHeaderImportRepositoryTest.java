    ...
    class SetJore4Ids {
        ...
        class WhenLineHeaderIsNotFound {
            ...
            private final List<PersistableLineIdMapping> INPUT = List.of(
                    PersistableLineIdMapping.of(UNKNOWN_EXT_ID_OF_LINE_HEADER, JORE4_ID_OF_LINE)
            );
            ...
            void shouldNotUpdateJore4IdToExistingLineHeader() {
                ...
                final LineHeader existingLineHeader = targetRepository.findByExternalId(EXT_ID_OF_LINE_HEADER).get();
        ...
        class WhenLineHeaderIsFound {
            ...
            private final List<PersistableLineIdMapping> INPUT = List.of(
                    PersistableLineIdMapping.of(EXT_ID_OF_LINE_HEADER.value(), JORE4_ID_OF_LINE)
            );
