...
public class LineHeaderImportRepositoryTest {
    ...
    class CommitStagingToTarget {
        ...
        private static final ExternalId LINE_EXT_ID =
                ExternalIdUtil.forLine(LineId.from(LINE_NUMBER));
        ...
        private static final ExternalId HEADER_EXT_ID =
                ExternalIdUtil.forLineHeader(
        ...
        public void beforeEach() {
            assertThat(
                    ...
                    is(true));
            assertThat(
                    "Line repository should be empty at the start of the test",
        ...
        public void whenNewStagedRowsAndCommit_andTargetDbEmpty_thenReturnResultWithInsertedId() {
            ...
            final Map<RowStatus, Set<LineHeaderPK>> result =
                    importRepository.commitStagingToTarget();

            assertThat(
                    "Only INSERTs should occur",
                    result.keySet(),
            ...
            assertThat(
                    "Target repository should contain a single row",
            ...
            assertThat(
                    "The inserted row is found in the target repository",
        ...
        @Test
        public void
                whenStagedRowsWithChangesAndCommit_andTargetNotEmpty_thenReturnResultWithIdOfUpdatedRow() {
            // Insert the parent line
            final LinePK lineId =
                    lineRepository.insert(
                            PersistableLine.of(
            ...
            final LineHeaderPK existingId =
                    targetRepository.insert(
                            PersistableLineHeader.of(
                                    HEADER_EXT_ID,
                                    lineId,
                                    NAME,
                                    NAME_SHORT,
            ...
            assertThat(
                    "Target repository (including history) should contain both the original and"
                            + " modified row",
                    targetRepository.countHistory(),
                    is(2));
            ...
            assertThat(
                    "The updated row is found in the target repository",
                    maybeLineHeader.isPresent(),
                    is(true));
        ...
        public void
            ...
            final DateRange newValidTime =
                    DateRange.between(LocalDate.of(2020, 5, 8), LocalDate.of(2021, 6, 20));
            ...
            final Optional<LineHeader> maybeLineHeader = targetRepository.findById(existingId);
            assertThat(
                    "The deleted row is no longer in the target repository",
        ...
        public void whenStagedRowsWithNoChangesAndCommit_andTargetNotEmpty_thenReturnEmptyResult() {
            ...
            final Optional<LineHeader> maybeLineHeader = targetRepository.findById(existingId);
            assertThat(
                    "The target row is found in the target repository",
                    maybeLineHeader.isPresent(),
                    is(true));
        ...
        public void whenNoStagedRowsAndCommit_andTargetNotEmpty_thenReturnResultWithDeletedId() {
            ...
            assertThat(
                    "Target repository should be empty after import",
                    targetRepository.empty(),
                    is(true));
    ...
    class SetJore4Ids {
        ...
        private final UUID JORE4_ID_OF_LINE =
                UUID.fromString("51f2686b-166c-4157-bd70-647337e44c8c");
            ...
            private final List<PersistableLineIdMapping> INPUT =
                    List.of(
                            PersistableLineIdMapping.of(
                                    UNKNOWN_EXT_ID_OF_LINE_HEADER, JORE4_ID_OF_LINE));
        ...
        class WhenLineHeaderIsFound {
            ...
            private final List<PersistableLineIdMapping> INPUT =
                    List.of(
                            PersistableLineIdMapping.of(
                                    EXT_ID_OF_LINE_HEADER.value(), JORE4_ID_OF_LINE));
            ...
            void shouldUpdateJore4IdToExistingLineHeader() {
                ...
                final LineHeader existingLineHeader =
                        targetRepository.findByExternalId(EXT_ID_OF_LINE_HEADER).get();
                assertThat(
                        existingLineHeader.jore4IdOfLine(), equalTo(Optional.of(JORE4_ID_OF_LINE)));
            }
        }
    }
}
