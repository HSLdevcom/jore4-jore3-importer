...
public class RouteGeometryTestFactory {
    ...
    public static final UUID ROUTE_DIRECTION_ID =
            UUID.fromString("0269ee59-730b-499a-8cf4-bef6f7923b3c");
    ...
    public static ImporterRouteGeometry createRouteGeometry() {
        final CoordinateSequence coordinates =
                new CoordinateArraySequence(
                        new Coordinate[] {
                            new Coordinate(
                                    REQUEST_ROUTE_GEOMETRY_START_X, REQUEST_ROUTE_GEOMETRY_START_Y),
                            new Coordinate(
                                    REQUEST_ROUTE_GEOMETRY_END_X, REQUEST_ROUTE_GEOMETRY_END_Y)
                        });
    ...
    private static ImporterRoutePoint createStopPoint() {
        final CoordinateSequence locationCoordinates =
                new CoordinateArraySequence(
                        new Coordinate[] {
                            new Coordinate(
                                    REQUEST_ROUTE_STOP_POINT_POINT_X,
                                    REQUEST_ROUTE_STOP_POINT_POINT_Y)
                        });
        final Point location =
                new Point(
                        locationCoordinates, GeometryUtil.factoryForSrid(GeometryUtil.SRID_WGS84));

        final CoordinateSequence projectedLocationCoordinates =
                new CoordinateArraySequence(
                        new Coordinate[] {
                            new Coordinate(
                                    REQUEST_ROUTE_STOP_POINT_PROJECTED_POINT_X,
                                    REQUEST_ROUTE_STOP_POINT_PROJECTED_POINT_Y)
                        });
    ...
    private static ImporterRoutePoint createJunctionPoint() {
        final CoordinateSequence locationCoordinates =
                new CoordinateArraySequence(
                        new Coordinate[] {
                            new Coordinate(
                                    REQUEST_ROUTE_JUNCTION_POINT_X, REQUEST_ROUTE_JUNCTION_POINT_Y)
                        });
        final Point location =
                new Point(
                        locationCoordinates, GeometryUtil.factoryForSrid(GeometryUtil.SRID_WGS84));
