...
public final class JoreLocaleUtil {
     ...
     */
    public static MultilingualString createMultilingualString(final String finnish, final String swedish) {
        return MultilingualString.of(Map.of(FINNISH.toString(), finnish, SWEDISH.toString(), swedish));
    }
