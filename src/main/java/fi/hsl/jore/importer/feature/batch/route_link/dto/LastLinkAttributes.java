...
/**
 * Jore 3 models the route direction as a sequence of links (between nodes), where each link
 * contains attributes of the starting node. Because there are 1 fewer links than nodes (e.g. a
 * route direction might contain 10 nodes with 9 links in between), the attributes of the last node
