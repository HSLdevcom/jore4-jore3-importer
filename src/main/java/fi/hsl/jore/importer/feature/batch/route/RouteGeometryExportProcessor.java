...
public class RouteGeometryExportProcessor implements ItemProcessor<ExportableRouteGeometry, TransmodelRouteGeometry> {
    ...
    private TransmodelRouteGeometry createRouteGeometry(final UUID routeId,
        ...
        final java.util.List<InfrastructureLinkResponseDTO> matchedInfraLinks = mapMatchingResponse
                .getRoutes().get(0)
                .getPaths();
        ...
        for (final InfrastructureLinkResponseDTO matchedInfraLink: matchedInfraLinks) {
            final ExternalLinkRefResponseDTO externalLink = matchedInfraLink.getExternalLinkRef();
