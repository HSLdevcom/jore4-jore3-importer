 ...
 */
public class InfrastructureLinkResponseDTO {

    private double distance;
    private ExternalLinkRefResponseDTO externalLinkRef;
    ...
    public ExternalLinkRefResponseDTO getExternalLinkRef() {
    ...
    public void setExternalLinkRef(final ExternalLinkRefResponseDTO externalLinkRef) {
