...
/** Reads the information of an exported journey pattern from the importer's database. */
public class JourneyPatternExportMapper implements RowMapper<ImporterJourneyPattern> {
    ...
    @Override
    public ImporterJourneyPattern mapRow(final ResultSet resultSet, final int rowNumber) throws SQLException {
