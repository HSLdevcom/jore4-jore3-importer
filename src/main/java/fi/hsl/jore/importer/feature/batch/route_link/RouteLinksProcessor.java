 ...
 * (embedded within a {@link RouteLinksAndAttributes container}), construct list of route {@link Jore3RoutePoint points} and
 * route {@link Jore3RouteStopPoint stop points} (embedded into a {@link Jore3RoutePointsAndLinks container}).
 * <p>
...
public class RouteLinksProcessor implements ItemProcessor<RouteLinksAndAttributes, Jore3RoutePointsAndLinks> {
    ...
    public Jore3RoutePointsAndLinks process(final RouteLinksAndAttributes item) {
        return Jore3RoutePointsAndLinks.of(RoutePointConstructor.extractPoints(item),
