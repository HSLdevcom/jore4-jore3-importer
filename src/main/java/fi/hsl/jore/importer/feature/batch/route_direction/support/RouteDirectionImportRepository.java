...
public class RouteDirectionImportRepository
    ...
    protected Set<RouteDirectionPK> delete() {
        return db.deleteFrom(TARGET_TABLE)
                 ...
                 .whereNotExists(selectOne()
                                         .from(STAGING_TABLE)
                                         .where(STAGING_TABLE.NETWORK_ROUTE_DIRECTION_EXT_ID.eq(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_EXT_ID)))
    ...
    protected Set<RouteDirectionPK> update() {
        return db.update(TARGET_TABLE)
                 ...
                 .set(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_LENGTH,
                      STAGING_TABLE.NETWORK_ROUTE_DIRECTION_LENGTH)
                 .set(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_NAME,
                      STAGING_TABLE.NETWORK_ROUTE_DIRECTION_NAME)
                 .set(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_NAME_SHORT,
                      STAGING_TABLE.NETWORK_ROUTE_DIRECTION_NAME_SHORT)
                 .set(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_ORIGIN,
                      STAGING_TABLE.NETWORK_ROUTE_DIRECTION_ORIGIN)
                 .set(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_DESTINATION,
                      STAGING_TABLE.NETWORK_ROUTE_DIRECTION_DESTINATION)
                 .set(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_VALID_DATE_RANGE,
                      STAGING_TABLE.NETWORK_ROUTE_DIRECTION_VALID_DATE_RANGE)
                 .from(STAGING_TABLE)
                 // Find source rows..
                 .where(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_EXT_ID
                                .eq(STAGING_TABLE.NETWORK_ROUTE_DIRECTION_EXT_ID))
                 // .. with updated fields
                 .and(
                         (TARGET_TABLE.NETWORK_ROUTE_DIRECTION_LENGTH.ne(STAGING_TABLE.NETWORK_ROUTE_DIRECTION_LENGTH))
                                 .or(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_NAME.ne(STAGING_TABLE.NETWORK_ROUTE_DIRECTION_NAME))
                                 .or(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_NAME_SHORT.ne(STAGING_TABLE.NETWORK_ROUTE_DIRECTION_NAME_SHORT))
                                 .or(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_ORIGIN.ne(STAGING_TABLE.NETWORK_ROUTE_DIRECTION_ORIGIN))
                                 .or(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_DESTINATION.ne(STAGING_TABLE.NETWORK_ROUTE_DIRECTION_DESTINATION))
                                 .or(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_VALID_DATE_RANGE.ne(STAGING_TABLE.NETWORK_ROUTE_DIRECTION_VALID_DATE_RANGE))
                 )
                 .returningResult(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_ID)
                 .fetch()
                 .stream()
    ...
    protected Set<RouteDirectionPK> insert() {
        return db.insertInto(TARGET_TABLE)
                 .columns(TARGET_TABLE.NETWORK_ROUTE_DIRECTION_EXT_ID,
                 ...
                 .select(db.select(STAGING_TABLE.NETWORK_ROUTE_DIRECTION_EXT_ID,
                                   ...
                                   STAGING_TABLE.NETWORK_ROUTE_DIRECTION_VALID_DATE_RANGE)
                           .from(STAGING_TABLE)
                           .leftJoin(ROUTES_TABLE).on(ROUTES_TABLE.NETWORK_ROUTE_EXT_ID.eq(STAGING_TABLE.NETWORK_ROUTE_EXT_ID))
                           .whereNotExists(selectOne()
                                                   .from(TARGET_TABLE)
