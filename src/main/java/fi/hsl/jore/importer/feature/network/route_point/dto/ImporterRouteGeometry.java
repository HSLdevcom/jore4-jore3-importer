...
/**
 * Contains the route geometry of a route. This information is used when the infrastructure links
 * from the Jore 4 database are linked with the routes found from the same database.
 */
@Value.Immutable
