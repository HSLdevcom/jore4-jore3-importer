...
public interface JrLineHeader extends IHasPrimaryKey<JrLineHeaderPk>, IHasLineId, IHasDuration {

    String TABLE = "jr_linjannimet";

    @Value.Derived
    default JrLineHeaderPk pk() {
        return JrLineHeaderPk.of(lineId(), validFrom(), validTo());
    }
    ...
    @JoreColumn(name = "linalkupvm", example = "2013-01-01 00:00:00.000")
    LocalDate validFrom();

    @JoreColumn(name = "linloppupvm", example = "2019-06-02 00:00:00.000")
    LocalDate validTo();

    @JoreColumn(name = "linnimi", example = "Olympiaterminaali - Kamppi (M) - Ooppera")
    String name();

    @JoreColumn(name = "linnimilyh", nullable = true, example = "Olympiaterm.-Ooppera")
    Optional<String> nameShort();

    @JoreColumn(name = "linnimir", nullable = true, example = "Olympiaterminalen - Kampen (M) - Operan")
    Optional<String> nameSwedish();

    @JoreColumn(name = "linnimilyh", nullable = true, example = "Olympiaterm.-Operan")
    Optional<String> nameShortSwedish();

    @JoreColumn(name = "linlahtop1", nullable = true, example = "Kauppatori / Eira")
    Optional<String> origin1();

    @JoreColumn(name = "linlahtop1r", nullable = true, example = "Salutorget / Eira")
    Optional<String> origin1Swedish();

    @JoreColumn(name = "linlahtop2", nullable = true, example = "Martinlaakso")
    Optional<String> origin2();

    @JoreColumn(name = "linlahtop2r", nullable = true, example = "Mårtensdal")
    Optional<String> origin2Swedish();

    static JrLineHeader of(
            final LineId lineId,
