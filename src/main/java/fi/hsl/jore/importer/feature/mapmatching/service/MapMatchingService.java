...
public class MapMatchingService implements IMapMatchingService {
    ...
    @Autowired
    public MapMatchingService(final String mapMatchingApiUrl, final RestTemplate restTemplate) {
        this.mapMatchingApiUrl = mapMatchingApiUrl;
    ...
    public MapMatchingResponseDTO sendMapMatchingRequest(final ExportableRouteGeometry routeGeometry,
        ...
        LOGGER.debug("Sendi g map matching request for the route direction: {}", routeGeometry.routeDirectionId());
