...
@Repository
public class LinkImportRepository extends AbstractImportRepository<Jore3Link, LinkPK>
    ...
    private static final InfrastructureLinks TARGET_TABLE =
        ...
        return db
                ...
                .select(
                        db.select(
                                ...
                                .on(
                                        nodeFromTable.INFRASTRUCTURE_NODE_EXT_ID.eq(
                                                STAGING_TABLE
                                                        .INFRASTRUCTURE_LINK_START_NODE_EXT_ID))
                                .innerJoin(nodeToTable)
                                .on(
                                        nodeToTable.INFRASTRUCTURE_NODE_EXT_ID.eq(
                                                STAGING_TABLE.INFRASTRUCTURE_LINK_END_NODE_EXT_ID))
                                .whereNotExists(
                                        selectOne()
                                                .from(TARGET_TABLE)
