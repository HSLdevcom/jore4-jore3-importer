 ...
 *
 * <p>For example, in a road network a link identifies the road section between two road intersections.
 *
 * <p>Links only specify the start and end nodes of the segment, the actual precise link path is described with a list
 * of points.
 */
@Value.Immutable
@JoreDtoStyle
@JoreTable(name = JrLink.TABLE)
public interface JrLink extends IHasPrimaryKey<JrLinkPk>, IHasTransitType, IHasNodes {
