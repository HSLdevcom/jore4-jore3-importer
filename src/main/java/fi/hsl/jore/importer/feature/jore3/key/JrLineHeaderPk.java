...
@Value.Immutable
public interface JrLineHeaderPk extends IHasLineId, IHasDuration {
    static JrLineHeaderPk of(final LineId lineId, final LocalDate validFrom, final LocalDate validTo) {
