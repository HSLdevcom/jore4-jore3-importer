...
public class RouteStopPointImportRepository
    ...
    private static final NetworkRouteStopPoints TARGET_TABLE =
            NetworkRouteStopPoints.NETWORK_ROUTE_STOP_POINTS;
    private static final NetworkRoutePoints ROUTE_POINTS_TABLE =
        ...
        return db
                ...
                .whereNotExists(
                        selectOne()
                                .from(STAGING_TABLE)
                                .where(
                                        STAGING_TABLE.NETWORK_ROUTE_STOP_POINT_EXT_ID.eq(
    ...
    protected Set<RouteStopPointPK> update() {
        return db
                ...
                // Find source rows...
                .where(
                        TARGET_TABLE.NETWORK_ROUTE_STOP_POINT_EXT_ID.eq(
                                STAGING_TABLE.NETWORK_ROUTE_STOP_POINT_EXT_ID))
                // ...with updated fields
                .and(
                        (TARGET_TABLE.NETWORK_ROUTE_STOP_POINT_ORDER.ne(
                                        STAGING_TABLE.NETWORK_ROUTE_STOP_POINT_ORDER))
                                .or(
                                        TARGET_TABLE.NETWORK_ROUTE_STOP_POINT_HASTUS_POINT.ne(
                                                STAGING_TABLE
                                        ...
                                        TARGET_TABLE
                                                ...
                                                .ne(
                                                        STAGING_TABLE
                                                                .NETWORK_ROUTE_STOP_POINT_REGULATED_TIMING_POINT_STATUS))
                                .or(
                                        TARGET_TABLE.NETWORK_ROUTE_STOP_POINT_VIA_POINT.ne(
                                                STAGING_TABLE.NETWORK_ROUTE_STOP_POINT_VIA_POINT))
        ...
        return db
                ...
                .select(
                        db.select(
                                        ...
                                        STAGING_TABLE.NETWORK_ROUTE_STOP_POINT_TIMETABLE_COLUMN)
                                .from(STAGING_TABLE)
                                // Note that the stop point ext id is the same as the referenced
                                // route point ext id
                                .innerJoin(ROUTE_POINTS_TABLE)
                                .on(
                                        ROUTE_POINTS_TABLE.NETWORK_ROUTE_POINT_EXT_ID.eq(
                                                STAGING_TABLE.NETWORK_ROUTE_STOP_POINT_EXT_ID))
                                .whereNotExists(
                                        selectOne()
                                                .from(TARGET_TABLE)
