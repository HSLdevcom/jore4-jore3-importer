...
public class StopPlaceImportRepository
    ...
    private static final List<String> ALLOWED_TRANSPORT_MODES = List.of(
            NetworkType.ROAD.label(),
            NetworkType.TRAM_TRACK.label()
    );
    ...
    protected Set<StopPlacePK> update() {
        return db
                ...
                .from(STAGING_TABLE)
                .where(
                        STAGING_TABLE.STOPS_STOP_PLACE_TRANSPORT_MODE.in(ALLOWED_TRANSPORT_MODES)
                        .and(TARGET_TABLE.STOPS_STOP_PLACE_EXT_ID
                                ...
                                .and(
                                    ...
                                    .or(TARGET_TABLE.STOPS_STOP_PLACE_TRANSPORT_MODE.notEqual(STAGING_TABLE.STOPS_STOP_PLACE_TRANSPORT_MODE))
                                )
                        )
                .returningResult(TARGET_TABLE.STOPS_STOP_PLACE_ID)
                .fetch()
