...
public final class RoutePointConstructor {
    ...
    private static Jore3RoutePoint fromLink(final JrRouteLink link,
                                            final int index) {
        return Jore3RoutePoint.of(ExternalIdUtil.forRouteLinkStartNode(link),
                                       ExternalIdUtil.forNode(link.startNode()),
                                       ExternalIdUtil.forRouteDirection(link.fkRouteDirection()),
                                       index);
    }

    private static Jore3RoutePoint fromLastLink(final JrRouteLink link,
                                                final int index) {
        return Jore3RoutePoint.of(ExternalIdUtil.forRouteLinkEndNode(link),
