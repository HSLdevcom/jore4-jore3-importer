 ...
 * fi.hsl.jore.importer.feature.batch.route_link.support.IRoutePointImportRepository this} to
 * insert/update/delete route points.
 */
@VisibleForTesting
public interface IRoutePointTestRepository
        extends IBasicCrudRepository<RoutePointPK, RoutePoint, PersistableRoutePoint>,
