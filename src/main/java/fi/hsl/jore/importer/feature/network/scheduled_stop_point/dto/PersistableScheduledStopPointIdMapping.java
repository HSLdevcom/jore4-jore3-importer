...
/**
 * Contains the information that's required to update the Jore 4 id (primary key of a scheduled stop
 * found from Jore 4 database) of a scheduled stop point stored in the database of the importer
 * application.
 */
@Value.Immutable
