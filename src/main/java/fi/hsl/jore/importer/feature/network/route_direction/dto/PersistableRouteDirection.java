...
/**
 * At the moment this variation of the line header is intended to be used with the
 * {@link fi.hsl.jore.importer.feature.network.line_header.repository.ILineHeaderTestRepository test repository}.
 */
@Value.Immutable
public interface PersistableRouteDirection extends CommonFields<PersistableRouteDirection> {

    RoutePK routeId();

    static PersistableRouteDirection of(
