...
/**
 * Maps a result set row into an {@link ExportableRouteGeometry} object.
 */
public class RouteGeometryExportMapper implements RowMapper<ExportableRouteGeometry> {

    public static final String SQL_PATH = "classpath:export/export_route_geometries.sql";

    @Override
    public ExportableRouteGeometry mapRow(final ResultSet resultSet,
        ...
        return ExportableRouteGeometry.from(
                routeGeometry,
