...
public class RouteGeometryExportMapper implements RowMapper<ImporterRouteGeometry> {
    ...
    @Override
    public ImporterRouteGeometry mapRow(final ResultSet resultSet, final int rowNumber) throws SQLException {
        final String routeGeometryHex = resultSet
                .getString("network_route_direction_shape")
