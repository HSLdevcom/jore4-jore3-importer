...
class DigiroadStopFactory {
    ...
    static Optional<DigiroadStop> fromCsvLine(final String line) {
        ...
        final DigiroadStop stop = DigiroadStop.of(
                ...
                parseRequiredInteger("elyNumber", columns[2]),
    ...
    private static String parseRequiredField(final String fieldName, final String source) {
    ...
    private static Integer parseRequiredInteger(final String fieldName, final String source) {
        final String value = parseRequiredField(fieldName, source);
        try {
