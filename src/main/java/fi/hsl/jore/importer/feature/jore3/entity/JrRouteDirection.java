...
public interface JrRouteDirection
        extends IHasPrimaryKey<JrRouteDirectionPk>,
                IHasRouteId,
                IHasDirection,
                IHasDuration {
    ...
    @JoreColumn(name = "suunimi",
                example = "Kaivoksela-Vantaankoski")
    String name();

    @JoreColumn(name = "suunimilyh",
                nullable = true,
                example = "Vantaankos-Kaivoksel")
    Optional<String> nameShort();

    @JoreColumn(name = "suunimir",
                nullable = true,
                example = "Gruvsta-Vandaforsen")
    Optional<String> nameSwedish();

    @JoreColumn(name = "suunimilyhr",
                nullable = true,
                example = "Vandaforsen-Gruvsta")
    Optional<String> nameShortSwedish();

    @JoreColumn(name = "suulahpaik",
                nullable = true,
                example = "Vantaankoski")
    Optional<String> origin();

    @JoreColumn(name = "suulahpaikr",
                nullable = true,
                example = "Vandaforsen")
    ...
    @JoreColumn(name = "suupaapaikr",
                nullable = true,
                example = "Gruvsta")
    Optional<String> destinationSwedish();

    @JoreColumn(name = "suupituus",
                nullable = true)
    Optional<Integer> lengthMeters();

    static JrRouteDirection of(final RouteId routeId,
