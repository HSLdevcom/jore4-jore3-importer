...
public interface IMapMatchingService {
     ...
     * @param routePoints The route points of the route. These route points are queried from the
     *     importer's database.
     * @return A response that describes the result of the map matching request. If the request was
     *     successful, the response contains the information of a public transport route which can
     *     be inserted into the Jore 4 database.
     */
