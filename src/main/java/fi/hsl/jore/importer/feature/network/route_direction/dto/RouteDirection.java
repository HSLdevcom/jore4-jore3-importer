...
/**
 * At the moment this variation of the route direction is intended to be used with the {@link
 * fi.hsl.jore.importer.feature.network.route_direction.repository.IRouteDirectionTestRepository
 * test repository}.
 */
@Value.Immutable
public interface RouteDirection
        extends IHasPK<RouteDirectionPK>, IHasSystemTime, CommonFields<RouteDirection> {
    ...
    static RouteDirection from(
            final NetworkRouteDirectionsRecord record, final IJsonbConverter converter) {
        return of(
                ...
                converter.fromJson(
                        record.getNetworkRouteDirectionNameShort(), MultilingualString.class),
                converter.fromJson(
                        record.getNetworkRouteDirectionOrigin(), MultilingualString.class),
                converter.fromJson(
                        record.getNetworkRouteDirectionDestination(), MultilingualString.class),
    ...
    static RouteDirection from(
            final NetworkRouteDirectionsWithHistoryRecord record, final IJsonbConverter converter) {
        return of(
                RouteDirectionPK.of(record.getNetworkRouteDirectionId()),
                RoutePK.of(record.getNetworkRouteId()),
                ExternalId.of(record.getNetworkRouteDirectionExtId()),
