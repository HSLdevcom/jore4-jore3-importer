...
public class RouteLinkImportRepository extends AbstractImportRepository<Jore3RouteLink, RouteLinkPK>
    ...
    private static final NetworkRouteLinksStaging STAGING_TABLE =
        ...
        return db
                ...
                .whereNotExists(
                        selectOne()
                                .from(STAGING_TABLE)
                                .where(
                                        STAGING_TABLE.NETWORK_ROUTE_LINK_EXT_ID.eq(
    ...
    protected Set<RouteLinkPK> update() {
        return db
                ...
                // Find source rows..
                .where(
                        TARGET_TABLE.NETWORK_ROUTE_LINK_EXT_ID.eq(
                                STAGING_TABLE.NETWORK_ROUTE_LINK_EXT_ID))
                // .. with updated fields
                .and(
                        (TARGET_TABLE.NETWORK_ROUTE_LINK_ORDER.ne(
                                STAGING_TABLE.NETWORK_ROUTE_LINK_ORDER)))
                .returningResult(TARGET_TABLE.NETWORK_ROUTE_LINK_ID)
                .fetch()
                .stream()
