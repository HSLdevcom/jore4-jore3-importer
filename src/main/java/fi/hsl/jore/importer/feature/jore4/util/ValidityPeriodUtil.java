...
/** Provides static utility methods which are used to construct the start and end timestamps of a validity period. */
public final class ValidityPeriodUtil {
     ...
     * @return An optional which contains the start time of a validity period. If the {@code startDay} is {@code null},
    ...
    public static Optional<LocalDate> constructValidityPeriodStartDay(final Range<LocalDate> validityPeriod) {
        return Optional.of(validityPeriod).filter(Range::hasLowerBound).map(ValidityPeriodUtil::determineStartDay);
    }
     ...
     *
     * @param validityPeriod The validity period.
     * @return An optional which cotnains the end time of a validity period. If the {@code startDay} is {@code null},
     *     this method returns an empty optional.
     */
    public static Optional<LocalDate> constructValidityPeriodEndDay(final Range<LocalDate> validityPeriod) {
        return Optional.of(validityPeriod).filter(Range::hasUpperBound).map(ValidityPeriodUtil::determineEndDay);
    }
