...
/**
 * Provides static utility methods which are used to construct the start and end timestamps of a
 * validity period.
 */
public final class ValidityPeriodUtil {
     ...
     * @return An optional which contains the start time of a validity period. If the {@code
     *     startDay} is {@code null}, this method returns an empty optional.
     */
    public static Optional<LocalDate> constructValidityPeriodStartDay(
            final Range<LocalDate> validityPeriod) {
    ...
    private static LocalDate determineStartDay(final Range<LocalDate> validityPeriod) {
        ...
        return validityPeriod.lowerBoundType() == BoundType.CLOSED
                ? lowerEndPoint
     ...
     *
     * @param validityPeriod The validity period.
     * @return An optional which cotnains the end time of a validity period. If the {@code startDay}
     *     is {@code null}, this method returns an empty optional.
     */
    public static Optional<LocalDate> constructValidityPeriodEndDay(
            final Range<LocalDate> validityPeriod) {
        return Optional.of(validityPeriod)
    ...
    private static LocalDate determineEndDay(final Range<LocalDate> validityPeriod) {
        ...
        return validityPeriod.upperBoundType() == BoundType.CLOSED
                ? upperEndPoint
