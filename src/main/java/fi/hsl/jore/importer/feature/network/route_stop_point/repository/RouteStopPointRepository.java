...
public class RouteStopPointRepository implements IRouteStopPointTestRepository {
    ...
    private static final NetworkRouteStopPoints POINTS =
    ...
    private static final TableField<NetworkRouteStopPointsRecord, UUID> PRIMARY_KEY =
    ...
    private static RouteStopPoint from(
            final NetworkRouteStopPointsRecord record, final IJsonbConverter converter) {
        return RouteStopPoint.of(
                ...
                RegulatedTimingPointStatus.of(
                                record.getNetworkRouteStopPointRegulatedTimingPointStatus())
                        .orElseThrow(),
                record.getNetworkRouteStopPointViaPoint(),
                Optional.ofNullable(
                        converter.fromJson(
                                record.getNetworkRouteStopPointViaName(),
