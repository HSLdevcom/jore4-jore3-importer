...
public class NodeWriter implements ItemWriter<List<PersistableNode>> {
    ...
    @Override
    public void write(final java.util.List<? extends List<PersistableNode>> lists) {
        final List<PersistableNode> nodes = lists.stream()
