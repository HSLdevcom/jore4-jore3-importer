...
public class TimingPlaceExportMapper implements RowMapper<ImporterTimingPlace> {
    ...
    @Override
    public ImporterTimingPlace mapRow(final ResultSet resultSet, final int rowNumber)
            throws SQLException {

        return ImporterTimingPlace.of(
                resultSet.getString("timing_place_label"),
                resultSet.getString("timing_place_name"));
    }
}
