...
/**
 * Transforms the input data read from the source database into a format which can be inserted into
 * the target database.
 */
public class ScheduledStopPointImportProcessor
        implements ItemProcessor<JrScheduledStopPoint, Jore3ScheduledStopPoint> {
