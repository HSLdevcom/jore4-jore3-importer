...
@Repository
public class LineHeaderImportRepository extends AbstractImportRepository<Jore3LineHeader, LineHeaderPK>
        implements ILineHeaderImportRepository {

    private static final NetworkLineHeadersStaging STAGING_TABLE =
    ...
    @Autowired
    public LineHeaderImportRepository(
    ...
    protected Set<LineHeaderPK> update() {
        return db
                ...
                .set(TARGET_TABLE.NETWORK_LINE_HEADER_NAME, STAGING_TABLE.NETWORK_LINE_HEADER_NAME)
                .set(TARGET_TABLE.NETWORK_LINE_HEADER_NAME_SHORT, STAGING_TABLE.NETWORK_LINE_HEADER_NAME_SHORT)
                .set(TARGET_TABLE.NETWORK_LINE_HEADER_ORIGIN_1, STAGING_TABLE.NETWORK_LINE_HEADER_ORIGIN_1)
                .set(TARGET_TABLE.NETWORK_LINE_HEADER_ORIGIN_2, STAGING_TABLE.NETWORK_LINE_HEADER_ORIGIN_2)
                ...
                .and((TARGET_TABLE.NETWORK_LINE_HEADER_NAME.ne(STAGING_TABLE.NETWORK_LINE_HEADER_NAME))
                        .or(TARGET_TABLE.NETWORK_LINE_HEADER_NAME_SHORT.ne(
                                STAGING_TABLE.NETWORK_LINE_HEADER_NAME_SHORT))
                        ...
                        .or(TARGET_TABLE.NETWORK_LINE_HEADER_VALID_DATE_RANGE.ne(
                                STAGING_TABLE.NETWORK_LINE_HEADER_VALID_DATE_RANGE)))
                .returningResult(TARGET_TABLE.NETWORK_LINE_HEADER_ID)
                .fetch()
                .stream()
    ...
    protected Set<LineHeaderPK> insert() {
        return db
                ...
                .columns(
                        TARGET_TABLE.NETWORK_LINE_HEADER_EXT_ID,
                ...
                .select(db.select(
                        ...
                        .on(LINES_TABLE.NETWORK_LINE_EXT_ID.eq(STAGING_TABLE.NETWORK_LINE_EXT_ID))
                        .whereNotExists(selectOne()
                                .from(TARGET_TABLE)
                                .where(TARGET_TABLE.NETWORK_LINE_HEADER_EXT_ID.eq(
                                        STAGING_TABLE.NETWORK_LINE_HEADER_EXT_ID))))
                .returningResult(TARGET_TABLE.NETWORK_LINE_HEADER_ID)
                .fetch()
                .stream()
