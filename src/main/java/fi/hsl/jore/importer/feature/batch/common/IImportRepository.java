...
public interface IImportRepository<ENTITY, KEY extends PK> {
    ...
    /**
     * Given a result from {@link IImportRepository#commitStagingToTarget}, calculate the number of
     * modifications.
     *
     ...
     */
    static <KEY extends PK> Map<RowStatus, Integer> commitCounts(
            final Map<RowStatus, Set<KEY>> commitStatus) {
