...
import fi.hsl.jore.importer.feature.batch.route.RouteGeometryExportMapper;
import fi.hsl.jore.importer.feature.batch.route.RouteGeometryExportProcessor;
...
public class JobConfig extends BatchConfig {
    ...
    public Step exportRouteGeometriesStep(final RouteGeometryExportReader reader,
                                          final RouteGeometryExportProcessor processor,
