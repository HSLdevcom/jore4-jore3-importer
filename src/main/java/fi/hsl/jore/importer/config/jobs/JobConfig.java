...
public class JobConfig {
    ...
    @Bean
    public Flow importNodesFlow(
            final Step prepareNodesStep, final Step importNodesStep, final Step commitNodesStep) {
    ...
    @Bean
    public Step importNodesStep(
            final NodeReader nodeReader, final INodeImportRepository nodeImportRepository) {
    ...
    @Bean
    public Flow importLinksFlow(
            final Step prepareLinksStep, final Step importLinksStep, final Step commitLinksStep) {
    ...
    @Bean
    public Step importLinksStep(
            final LinkRowReader linkReader, final ILinkImportRepository linkImportRepository) {
        final int chunkSize = 1000;
    ...
    public Flow importLinkPointsFlow(
            final Step prepareLinkPointsStep,
    ...
    @Bean
    public Flow importLinesFlow(
            final Step prepareLinesStep, final Step importLinesStep, final Step commitLinesStep) {
    ...
    @Bean
    public Step importLinesStep(
            final LineRowReader lineReader, final ILineImportRepository lineImportRepository) {
        final int chunkSize = 1000;
    ...
    public Flow importLineHeadersFlow(
            final Step prepareLineHeadersStep,
    ...
    @Bean
    public Step commitLineHeadersStep(
            final ILineHeaderImportRepository lineHeaderImportRepository) {
    ...
    @Bean
    public Step importRoutesStep(
            final RouteReader routeReader, final IRouteImportRepository routeImportRepository) {
        final int chunkSize = 1000;
    ...
    @Bean
    public Step prepareRouteDirectionsStep(
        ...
        return new StepBuilder("prepareRouteDirectionsStep", jobRepository)
                .allowStartIfComplete(true)
                .tasklet(
                        new GenericCleanupTasklet<>(routeDirectionImportRepository),
                        transactionManager)
                .build();
    }
    ...
    @Bean
    public Step commitRouteDirectionsStep(
            final IRouteDirectionImportRepository routeDirectionImportRepository) {
        return new StepBuilder("commitRouteDirectionsStep", jobRepository)
                .allowStartIfComplete(true)
                .tasklet(
                        new GenericCommitTasklet<>(routeDirectionImportRepository),
                        transactionManager)
                .build();
    }
    ...
    @Bean
    public Step prepareRoutePointsStep(
            final IRoutePointImportRepository routePointImportRepository) {
        return new StepBuilder("prepareRoutePointsStep", jobRepository)
                .allowStartIfComplete(true)
                .tasklet(
                        new GenericCleanupTasklet<>(routePointImportRepository), transactionManager)
                .build();
    }

    @Bean
    public Step prepareRouteStopPointsStep(
        ...
        return new StepBuilder("prepareRouteStopPointsStep", jobRepository)
                .allowStartIfComplete(true)
                .tasklet(
                        new GenericCleanupTasklet<>(routeStopPointImportRepository),
                        transactionManager)
                .build();
    }
    ...
    public Step importRouteLinksStep(
        ...
        return new StepBuilder("importRouteLinksStep", jobRepository)
                .allowStartIfComplete(true)
                .<RouteLinksAndAttributes, Jore3RoutePointsAndLinks>chunk(
                        chunkSize, transactionManager)
                .reader(new RouteLinksReader(routeLinkReader.build()))
                .processor(new RouteLinksProcessor())
                // Note how we write the route points, stop points, and route links to three
                // different repositories
                .writer(
                        new RouteLinksWriter(
                                routePointImportRepository,
    ...
    @Bean
    public Step commitRoutePointsStep(
            final IRoutePointImportRepository routePointImportRepository) {
    ...
    @Bean
    public Step commitRouteStopPointsStep(
            final IRouteStopPointImportRepository routeStopPointImportRepository) {
        return new StepBuilder("commitRouteStopPointsStep", jobRepository)
                .allowStartIfComplete(true)
                .tasklet(
                        new GenericCommitTasklet<>(routeStopPointImportRepository),
                        transactionManager)
                .build();
    }
    ...
    public Step importPlacesStep(
            final PlaceImportRowReader placeReader,
    ...
    @Bean
    public Step prepareScheduledStopPointsStep(
    ...
    public Step importScheduledStopPointsStep(
            final ScheduledStopPointImportReader reader,
            final IScheduledStopPointImportRepository repository) {
    ...
    @Bean
    public Step commitScheduledStopPointsStep(
            final IScheduledStopPointImportRepository repository) {
    ...
    @Bean
    public Step exportTimingPlacesStep(
            final TimingPlaceExportReader reader, final TimingPlaceExportWriter writer) {
    ...
    public Step exportRoutesStep(
            final RouteExportReader reader,
    ...
    public Step exportJourneyPatternStopsStep(
        ...
        return new StepBuilder("exportJourneyPatternStopsStep", jobRepository)
                .allowStartIfComplete(true)
                .<ImporterJourneyPatternStop, Jore4JourneyPatternStop>chunk(
                        1000, transactionManager)
                .reader(reader.build())
                .processor(processor)
                .writer(writer)
                .faultTolerant()
