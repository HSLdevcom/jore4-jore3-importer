...
public final class RangeUtil {
    ...
    private static <T extends Comparable<? super T>> Range<T> between(final T from,
                                                                      final T to,
    ...
    private static <T extends Comparable<? super T>> Range<T> beginningFrom(final T from,
                                                                            final boolean startInclusive) {
        return startInclusive ? Range.atLeast(from) : Range.greaterThan(from);
    }

    private static <T extends Comparable<? super T>> Range<T> endingTo(final T to,
                                                                       final boolean endInclusive) {
        return endInclusive ? Range.atMost(to) : Range.lessThan(to);
    }

    public static <T extends Comparable<? super T>> Range<T> asRange(final Optional<T> maybeFrom,
    ...
    public static <T extends Comparable<? super T>> String render(final Range<T> range,
