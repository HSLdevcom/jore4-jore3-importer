...
public final class RangeUtil {
    ...
    private static <T extends Comparable<? super T>> Range<T> endingTo(
            final T to, final boolean endInclusive) {
    ...
    public static <T extends Comparable<? super T>> Range<T> asRange(
        ...
        return maybeFrom
                .map(
                        from ->
                                maybeTo.map(to -> between(from, to, startInclusive, endInclusive))
