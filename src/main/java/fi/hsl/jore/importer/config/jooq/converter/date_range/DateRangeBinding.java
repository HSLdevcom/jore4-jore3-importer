...
public class DateRangeBinding implements Binding<Object, DateRange> {
    ...
    @Override
    public void set(final BindingSetSQLOutputContext<DateRange> ctx) throws SQLFeatureNotSupportedException {
        throw new SQLFeatureNotSupportedException();
    }

    @Override
    public void get(final BindingGetSQLInputContext<DateRange> ctx) throws SQLFeatureNotSupportedException {
        throw new SQLFeatureNotSupportedException();
    }
}
