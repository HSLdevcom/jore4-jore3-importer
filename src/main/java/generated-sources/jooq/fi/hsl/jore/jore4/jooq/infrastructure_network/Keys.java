...
public class Keys {
    ...
    public static final ForeignKey<VehicleSubmodeOnInfrastructureLinkRecord, InfrastructureLinkRecord> VEHICLE_SUBMODE_ON_INFRASTRUCTURE_LINK__VEHICLE_SUBMODE_ON_INFRASTRUCTURE_L_INFRASTRUCTURE_LINK_ID_FKEY = Internal.createForeignKey(VehicleSubmodeOnInfrastructureLink.VEHICLE_SUBMODE_ON_INFRASTRUCTURE_LINK, DSL.name("vehicle_submode_on_infrastructure_l_infrastructure_link_id_fkey"), new TableField[] { VehicleSubmodeOnInfrastructureLink.VEHICLE_SUBMODE_ON_INFRASTRUCTURE_LINK.INFRASTRUCTURE_LINK_ID }, Keys.INFRASTRUCTURE_LINK_PKEY, new TableField[] { InfrastructureLink.INFRASTRUCTURE_LINK.INFRASTRUCTURE_LINK_ID }, true);
