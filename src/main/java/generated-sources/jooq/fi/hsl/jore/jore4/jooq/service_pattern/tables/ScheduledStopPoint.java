...
public class ScheduledStopPoint extends TableImpl<ScheduledStopPointRecord> {
     ...
     */
    @Deprecated
    public final TableField<ScheduledStopPointRecord, Object> MEASURED_LOCATION = createField(DSL.name("measured_location"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geography\""), this, "The measured location describes the physical location of the stop. For some stops this describes the location of the pole-mounted flag. A PostGIS PointZ geography in EPSG:4326.");
