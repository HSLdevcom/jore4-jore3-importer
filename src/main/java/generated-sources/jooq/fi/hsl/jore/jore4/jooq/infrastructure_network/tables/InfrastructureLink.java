...
public class InfrastructureLink extends TableImpl<InfrastructureLinkRecord> {
     ...
     */
    @Deprecated
    public final TableField<InfrastructureLinkRecord, Object> SHAPE = createField(DSL.name("shape"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geography\"").nullable(false), this, "A PostGIS LinestringZ geography in EPSG:4326 describing the infrastructure link.");
