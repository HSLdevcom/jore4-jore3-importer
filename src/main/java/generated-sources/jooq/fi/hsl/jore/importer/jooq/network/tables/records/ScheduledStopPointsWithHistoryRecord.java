...
public class ScheduledStopPointsWithHistoryRecord extends TableRecordImpl<ScheduledStopPointsWithHistoryRecord> implements Record8<UUID, String, UUID, Long, JSONB, TimeRange, String, UUID> {
    ...
    @Override
    public Row8<UUID, String, UUID, Long, JSONB, TimeRange, String, UUID> valuesRow() {
    ...
    @Override
    public ScheduledStopPointsWithHistoryRecord values(UUID value1, String value2, UUID value3, Long value4, JSONB value5, TimeRange value6, String value7, UUID value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScheduledStopPointsWithHistoryRecord(UUID scheduledStopPointId, String scheduledStopPointExtId, UUID infrastructureNodeId, Long scheduledStopPointElyNumber, JSONB scheduledStopPointName, TimeRange scheduledStopPointSysPeriod, String scheduledStopPointShortId, UUID scheduledStopPointTransmodelId) {
        super(ScheduledStopPointsWithHistory.SCHEDULED_STOP_POINTS_WITH_HISTORY);
