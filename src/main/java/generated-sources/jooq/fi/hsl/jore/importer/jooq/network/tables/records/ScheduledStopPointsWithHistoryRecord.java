...
public class ScheduledStopPointsWithHistoryRecord extends TableRecordImpl<ScheduledStopPointsWithHistoryRecord> implements Record9<UUID, String, UUID, Long, JSONB, TimeRange, String, UUID, Integer> {
    ...
    @Override
    public Row9<UUID, String, UUID, Long, JSONB, TimeRange, String, UUID, Integer> valuesRow() {
    ...
    @Override
    public ScheduledStopPointsWithHistoryRecord values(UUID value1, String value2, UUID value3, Long value4, JSONB value5, TimeRange value6, String value7, UUID value8, Integer value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
