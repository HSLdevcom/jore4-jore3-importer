...
public class InfrastructureLinkShapesWithHistory extends TableImpl<InfrastructureLinkShapesWithHistoryRecord> {
    ...
    /**
     * The column <code>infrastructure_network.infrastructure_link_shapes_with_history.infrastructure_link_link_id</code>.
     */
    public final TableField<InfrastructureLinkShapesWithHistoryRecord, UUID> INFRASTRUCTURE_LINK_LINK_ID = createField(DSL.name("infrastructure_link_link_id"), SQLDataType.UUID, this, "");
