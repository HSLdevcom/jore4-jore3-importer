...
public class InfrastructureLinkShapes extends TableImpl<InfrastructureLinkShapesRecord> {
    ...
    /**
     * The column <code>infrastructure_network.infrastructure_link_shapes.infrastructure_link_link_id</code>.
     */
    public final TableField<InfrastructureLinkShapesRecord, UUID> INFRASTRUCTURE_LINK_LINK_ID = createField(DSL.name("infrastructure_link_link_id"), SQLDataType.UUID.nullable(false), this, "");
    ...
    public List<ForeignKey<InfrastructureLinkShapesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<InfrastructureLinkShapesRecord, ?>>asList(Keys.INFRASTRUCTURE_LINK_SHAPES__INFRASTRUCTURE_LINK_SHAPES_INFRASTRUCTURE_LINK_LINK_ID_FKEY);
    }
    ...
    public InfrastructureLinks infrastructureLinks() {
        if (_infrastructureLinks == null)
            _infrastructureLinks = new InfrastructureLinks(this, Keys.INFRASTRUCTURE_LINK_SHAPES__INFRASTRUCTURE_LINK_SHAPES_INFRASTRUCTURE_LINK_LINK_ID_FKEY);
