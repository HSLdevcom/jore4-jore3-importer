...
public class NetworkRouteStopPointsStagingRecord extends UpdatableRecordImpl<NetworkRouteStopPointsStagingRecord> implements Record5<String, Integer, Boolean, Integer, Boolean> {
    ...
    @Override
    public Row5<String, Integer, Boolean, Integer, Boolean> valuesRow() {
    ...
    @Override
    public NetworkRouteStopPointsStagingRecord values(String value1, Integer value2, Boolean value3, Integer value4, Boolean value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkRouteStopPointsStagingRecord(String networkRouteStopPointExtId, Integer networkRouteStopPointOrder, Boolean networkRouteStopPointHastusPoint, Integer networkRouteStopPointTimetableColumn, Boolean networkRouteStopPointViaPoint) {
        super(NetworkRouteStopPointsStaging.NETWORK_ROUTE_STOP_POINTS_STAGING);
