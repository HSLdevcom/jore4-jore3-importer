...
public class ScheduledStopPoint extends TableImpl<ScheduledStopPointRecord> {
     ...
     */
    @Deprecated
    public final TableField<ScheduledStopPointRecord, Object> MEASURED_LOCATION = createField(DSL.name("measured_location"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geography\"").nullable(false), this, "");
