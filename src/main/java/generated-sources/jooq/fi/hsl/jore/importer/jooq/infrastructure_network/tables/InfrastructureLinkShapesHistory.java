...
public class InfrastructureLinkShapesHistory extends TableImpl<InfrastructureLinkShapesHistoryRecord> {
    ...
    /**
     * The column <code>infrastructure_network.infrastructure_link_shapes_history.infrastructure_link_link_id</code>.
     */
    public final TableField<InfrastructureLinkShapesHistoryRecord, UUID> INFRASTRUCTURE_LINK_LINK_ID = createField(DSL.name("infrastructure_link_link_id"), SQLDataType.UUID.nullable(false), this, "");
