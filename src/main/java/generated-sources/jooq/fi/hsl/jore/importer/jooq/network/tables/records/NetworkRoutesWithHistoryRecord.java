...
public class NetworkRoutesWithHistoryRecord extends TableRecordImpl<NetworkRoutesWithHistoryRecord> implements Record8<UUID, UUID, String, String, JSONB, TimeRange, UUID, UUID> {
    ...
    /**
     * Setter for <code>network.network_routes_with_history.network_route_transmodel_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.network_route_transmodel_id</code>.
     */
    ...
    /**
     * Setter for <code>network.network_routes_with_history.journey_pattern_transmodel_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.journey_pattern_transmodel_id</code>.
     */
    ...
    public Field<UUID> field7() {
        return NetworkRoutesWithHistory.NETWORK_ROUTES_WITH_HISTORY.NETWORK_ROUTE_TRANSMODEL_ID;
    }

    @Override
    public Field<UUID> field8() {
        return NetworkRoutesWithHistory.NETWORK_ROUTES_WITH_HISTORY.JOURNEY_PATTERN_TRANSMODEL_ID;
    }
    ...
    @Override
    public NetworkRoutesWithHistoryRecord value7(UUID value) {
        setNetworkRouteTransmodelId(value);
        return this;
    }

    @Override
    public NetworkRoutesWithHistoryRecord value8(UUID value) {
        setJourneyPatternTransmodelId(value);
        return this;
    }

    @Override
    public NetworkRoutesWithHistoryRecord values(UUID value1, UUID value2, String value3, String value4, JSONB value5, TimeRange value6, UUID value7, UUID value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkRoutesWithHistoryRecord(UUID networkRouteId, UUID networkLineId, String networkRouteExtId, String networkRouteNumber, JSONB networkRouteName, TimeRange networkRouteSysPeriod, UUID networkRouteTransmodelId, UUID journeyPatternTransmodelId) {
        super(NetworkRoutesWithHistory.NETWORK_ROUTES_WITH_HISTORY);
