...
public class NetworkRouteStopPointsWithHistoryRecord extends TableRecordImpl<NetworkRouteStopPointsWithHistoryRecord> implements Record6<UUID, String, Integer, Boolean, Integer, TimeRange> {
    ...
    @Override
    public NetworkRouteStopPointsWithHistoryRecord values(UUID value1, String value2, Integer value3, Boolean value4, Integer value5, TimeRange value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkRouteStopPointsWithHistoryRecord(UUID networkRoutePointId, String networkRouteStopPointExtId, Integer networkRouteStopPointOrder, Boolean networkRouteStopPointHastusPoint, Integer networkRouteStopPointTimetableColumn, TimeRange networkRouteStopPointSysPeriod) {
        super(NetworkRouteStopPointsWithHistory.NETWORK_ROUTE_STOP_POINTS_WITH_HISTORY);
