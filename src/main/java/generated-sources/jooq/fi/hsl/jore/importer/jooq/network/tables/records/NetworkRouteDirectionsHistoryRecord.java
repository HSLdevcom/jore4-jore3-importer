...
public class NetworkRouteDirectionsHistoryRecord extends TableRecordImpl<NetworkRouteDirectionsHistoryRecord> implements Record13<UUID, UUID, String, String, Integer, JSONB, JSONB, JSONB, JSONB, DateRange, TimeRange, UUID, UUID> {
    ...
    /**
     * Setter for <code>network.network_route_directions_history.network_route_transmodel_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_route_directions_history.network_route_transmodel_id</code>.
     */
    ...
    /**
     * Setter for <code>network.network_route_directions_history.journey_pattern_transmodel_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_route_directions_history.journey_pattern_transmodel_id</code>.
     */
    ...
    public Field<UUID> field12() {
        return NetworkRouteDirectionsHistory.NETWORK_ROUTE_DIRECTIONS_HISTORY.NETWORK_ROUTE_TRANSMODEL_ID;
    }

    @Override
    public Field<UUID> field13() {
        return NetworkRouteDirectionsHistory.NETWORK_ROUTE_DIRECTIONS_HISTORY.JOURNEY_PATTERN_TRANSMODEL_ID;
    }
    ...
    @Override
    public NetworkRouteDirectionsHistoryRecord value12(UUID value) {
        setNetworkRouteTransmodelId(value);
        return this;
    }

    @Override
    public NetworkRouteDirectionsHistoryRecord value13(UUID value) {
        setJourneyPatternTransmodelId(value);
        return this;
    }

    @Override
    public NetworkRouteDirectionsHistoryRecord values(UUID value1, UUID value2, String value3, String value4, Integer value5, JSONB value6, JSONB value7, JSONB value8, JSONB value9, DateRange value10, TimeRange value11, UUID value12, UUID value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
