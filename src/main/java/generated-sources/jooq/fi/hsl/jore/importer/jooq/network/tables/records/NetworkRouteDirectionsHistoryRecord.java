...
public class NetworkRouteDirectionsHistoryRecord extends TableRecordImpl<NetworkRouteDirectionsHistoryRecord> implements Record13<UUID, UUID, String, String, Integer, JSONB, JSONB, JSONB, JSONB, DateRange, TimeRange, UUID, UUID> {
    ...
    /**
     * Setter for <code>network.network_route_directions_history.network_route_jore4_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_route_directions_history.network_route_jore4_id</code>.
     */
    ...
    /**
     * Setter for <code>network.network_route_directions_history.journey_pattern_jore4_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_route_directions_history.journey_pattern_jore4_id</code>.
     */
    ...
    public Field<UUID> field12() {
        return NetworkRouteDirectionsHistory.NETWORK_ROUTE_DIRECTIONS_HISTORY.NETWORK_ROUTE_JORE4_ID;
    }

    @Override
    public Field<UUID> field13() {
        return NetworkRouteDirectionsHistory.NETWORK_ROUTE_DIRECTIONS_HISTORY.JOURNEY_PATTERN_JORE4_ID;
    }
