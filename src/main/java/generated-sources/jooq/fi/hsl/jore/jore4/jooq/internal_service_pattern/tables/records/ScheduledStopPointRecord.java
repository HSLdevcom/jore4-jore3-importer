...
public class ScheduledStopPointRecord extends UpdatableRecordImpl<ScheduledStopPointRecord> implements Record5<UUID, Object, UUID, String, String> {
    ...
    @Override
    public Row5<UUID, Object, UUID, String, String> fieldsRow() {
        return (Row5) super.fieldsRow();
    }

    @Override
    public Row5<UUID, Object, UUID, String, String> valuesRow() {
    ...
    @Deprecated
    @Override
    public ScheduledStopPointRecord value2(Object value) {
    ...
    @Override
    public ScheduledStopPointRecord values(UUID value1, Object value2, UUID value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScheduledStopPointRecord(UUID scheduledStopPointId, Object measuredLocation, UUID locatedOnInfrastructureLinkId, String direction, String label) {
        super(ScheduledStopPoint.SCHEDULED_STOP_POINT);
