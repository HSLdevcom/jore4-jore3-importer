...
public class ScheduledStopPointRecord extends UpdatableRecordImpl<ScheduledStopPointRecord> implements Record8<UUID, Point, UUID, String, String, OffsetDateTime, OffsetDateTime, Integer> {
    ...
    @Override
    public Row8<UUID, Point, UUID, String, String, OffsetDateTime, OffsetDateTime, Integer> valuesRow() {
    ...
    @Override
    public ScheduledStopPointRecord value6(OffsetDateTime value) {
        setValidityStart(value);
        return this;
    }

    @Override
    public ScheduledStopPointRecord value7(OffsetDateTime value) {
    ...
    @Override
    public ScheduledStopPointRecord values(UUID value1, Point value2, UUID value3, String value4, String value5, OffsetDateTime value6, OffsetDateTime value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScheduledStopPointRecord(UUID scheduledStopPointId, Point measuredLocation, UUID locatedOnInfrastructureLinkId, String direction, String label, OffsetDateTime validityStart, OffsetDateTime validityEnd, Integer priority) {
        super(ScheduledStopPoint.SCHEDULED_STOP_POINT);
