...
public class ScheduledStopPointInJourneyPattern extends TableImpl<Record> {
    ...
    /**
     * The column <code>journey_pattern.scheduled_stop_point_in_journey_pattern.is_used_as_timing_point</code>. Is this scheduled stop point used as a timing point in the journey pattern?
     */
    ...
    /**
     * The column <code>journey_pattern.scheduled_stop_point_in_journey_pattern.via_point_name_i18n</code>.
     */
    public final TableField<Record, JSONB> VIA_POINT_NAME_I18N = createField(DSL.name("via_point_name_i18n"), SQLDataType.JSONB, this, "");

    /**
     * The column <code>journey_pattern.scheduled_stop_point_in_journey_pattern.via_point_short_name_i18n</code>.
     */
    ...
    /**
     * The column <code>journey_pattern.scheduled_stop_point_in_journey_pattern.scheduled_stop_point_label</code>.
     */
    ...
    /**
     * The column <code>journey_pattern.scheduled_stop_point_in_journey_pattern.is_loading_time_allowed</code>. Is adding loading time to this scheduled stop point in the journey pattern allowed?
     */
    ...
    /**
     * The column <code>journey_pattern.scheduled_stop_point_in_journey_pattern.is_regulated_timing_point</code>. Is this stop point passing time regulated so that it cannot be passed before scheduled time?
     */
