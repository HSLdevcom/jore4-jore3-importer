...
public class ScheduledStopPointsHistoryRecord extends TableRecordImpl<ScheduledStopPointsHistoryRecord> implements Record6<UUID, String, UUID, Point, JSONB, TimeRange> {
    ...
    /**
     * Setter for <code>network.scheduled_stop_points_history.scheduled_stop_point_location</code>.
     */
    ...
    /**
     * Getter for <code>network.scheduled_stop_points_history.scheduled_stop_point_location</code>.
     */
    ...
    public Field<Point> field4() {
        return ScheduledStopPointsHistory.SCHEDULED_STOP_POINTS_HISTORY.SCHEDULED_STOP_POINT_LOCATION;
    }
    ...
    @Override
    public ScheduledStopPointsHistoryRecord value4(Point value) {
    ...
    @Override
    public ScheduledStopPointsHistoryRecord values(UUID value1, String value2, UUID value3, Point value4, JSONB value5, TimeRange value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScheduledStopPointsHistoryRecord(UUID scheduledStopPointId, String scheduledStopPointExtId, UUID infrastructureNodeId, Point scheduledStopPointLocation, JSONB scheduledStopPointName, TimeRange scheduledStopPointSysPeriod) {
        super(ScheduledStopPointsHistory.SCHEDULED_STOP_POINTS_HISTORY);
