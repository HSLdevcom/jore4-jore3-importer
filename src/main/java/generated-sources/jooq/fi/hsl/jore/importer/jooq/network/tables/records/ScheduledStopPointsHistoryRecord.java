...
public class ScheduledStopPointsHistoryRecord extends TableRecordImpl<ScheduledStopPointsHistoryRecord> implements Record10<UUID, String, UUID, Long, JSONB, TimeRange, String, UUID, Integer, String> {
    ...
    /**
     * Setter for <code>network.scheduled_stop_points_history.hastus_place_id</code>.
     */
    ...
    /**
     * Getter for <code>network.scheduled_stop_points_history.hastus_place_id</code>.
     */
    ...
    public Field<String> field10() {
        return ScheduledStopPointsHistory.SCHEDULED_STOP_POINTS_HISTORY.HASTUS_PLACE_ID;
    }
    ...
    @Override
    public ScheduledStopPointsHistoryRecord value10(String value) {
        setHastusPlaceId(value);
        return this;
    }

    @Override
    public ScheduledStopPointsHistoryRecord values(UUID value1, String value2, UUID value3, Long value4, JSONB value5, TimeRange value6, String value7, UUID value8, Integer value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
