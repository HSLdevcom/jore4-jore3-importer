...
public class ScheduledStopPointsHistoryRecord extends TableRecordImpl<ScheduledStopPointsHistoryRecord> implements Record8<UUID, String, UUID, Long, JSONB, TimeRange, String, UUID> {
    ...
    @Override
    public ScheduledStopPointsHistoryRecord values(UUID value1, String value2, UUID value3, Long value4, JSONB value5, TimeRange value6, String value7, UUID value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScheduledStopPointsHistoryRecord(UUID scheduledStopPointId, String scheduledStopPointExtId, UUID infrastructureNodeId, Long scheduledStopPointElyNumber, JSONB scheduledStopPointName, TimeRange scheduledStopPointSysPeriod, String scheduledStopPointShortId, UUID scheduledStopPointTransmodelId) {
        super(ScheduledStopPointsHistory.SCHEDULED_STOP_POINTS_HISTORY);
