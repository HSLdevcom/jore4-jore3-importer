...
public class ScheduledStopPointsHistoryRecord extends TableRecordImpl<ScheduledStopPointsHistoryRecord> implements Record6<UUID, String, UUID, String, JSONB, TimeRange> {
    ...
    @Override
    public ScheduledStopPointsHistoryRecord values(UUID value1, String value2, UUID value3, String value4, JSONB value5, TimeRange value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScheduledStopPointsHistoryRecord(UUID scheduledStopPointId, String scheduledStopPointExtId, UUID infrastructureNodeId, String scheduledStopPointElyNumber, JSONB scheduledStopPointName, TimeRange scheduledStopPointSysPeriod) {
        super(ScheduledStopPointsHistory.SCHEDULED_STOP_POINTS_HISTORY);
