...
public class ScheduledStopPointsStagingRecord extends UpdatableRecordImpl<ScheduledStopPointsStagingRecord> implements Record3<String, String, JSONB> {
    ...
    @Override
    public ScheduledStopPointsStagingRecord values(String value1, String value2, JSONB value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public ScheduledStopPointsStagingRecord(String scheduledStopPointExtId, String scheduledStopPointElyNumber, JSONB scheduledStopPointName) {
        super(ScheduledStopPointsStaging.SCHEDULED_STOP_POINTS_STAGING);
