...
public class ScheduledStopPointsStagingRecord extends UpdatableRecordImpl<ScheduledStopPointsStagingRecord> implements Record4<String, Long, JSONB, String> {
    ...
    @Override
    public Row4<String, Long, JSONB, String> fieldsRow() {
        return (Row4) super.fieldsRow();
    }

    @Override
    public Row4<String, Long, JSONB, String> valuesRow() {
    ...
    @Override
    public ScheduledStopPointsStagingRecord values(String value1, Long value2, JSONB value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScheduledStopPointsStagingRecord(String scheduledStopPointExtId, Long scheduledStopPointElyNumber, JSONB scheduledStopPointName, String scheduledStopPointShortId) {
        super(ScheduledStopPointsStaging.SCHEDULED_STOP_POINTS_STAGING);
