...
public class NetworkLinesWithHistoryRecord extends TableRecordImpl<NetworkLinesWithHistoryRecord> implements Record9<UUID, String, String, String, TimeRange, UUID, String, String, String> {
    ...
    @Override
    public Row9<UUID, String, String, String, TimeRange, UUID, String, String, String> valuesRow() {
        return (Row9) super.valuesRow();
    }

    @Override
    public Field<UUID> field1() {
        return NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY.NETWORK_LINE_ID;
    }

    @Override
    public Field<String> field2() {
        return NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY.NETWORK_LINE_EXT_ID;
    }

    @Override
    public Field<String> field3() {
        return NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY.NETWORK_LINE_NUMBER;
    }

    @Override
    public Field<String> field4() {
        return NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY.INFRASTRUCTURE_NETWORK_TYPE;
    }

    @Override
    public Field<TimeRange> field5() {
        return NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY.NETWORK_LINE_SYS_PERIOD;
    }

    @Override
    public Field<UUID> field6() {
        return NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY.NETWORK_LINE_JORE4_ID;
    }

    @Override
    public Field<String> field7() {
        return NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY.NETWORK_LINE_TYPE_OF_LINE;
    }

    @Override
    public Field<String> field8() {
        return NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY.NETWORK_LINE_LEGACY_HSL_MUNICIPALITY_CODE;
    }

    @Override
    public Field<String> field9() {
        return NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY.NETWORK_LINE_EXPORT_ID;
    }
    ...
    @Override
    public NetworkLinesWithHistoryRecord value1(UUID value) {
        setNetworkLineId(value);
        return this;
    }

    @Override
    public NetworkLinesWithHistoryRecord value2(String value) {
        setNetworkLineExtId(value);
        return this;
    }

    @Override
    public NetworkLinesWithHistoryRecord value3(String value) {
        setNetworkLineNumber(value);
        return this;
    }

    @Override
    public NetworkLinesWithHistoryRecord value4(String value) {
        setInfrastructureNetworkType(value);
        return this;
    }

    @Override
    public NetworkLinesWithHistoryRecord value5(TimeRange value) {
        setNetworkLineSysPeriod(value);
        return this;
    }

    @Override
    public NetworkLinesWithHistoryRecord value6(UUID value) {
        setNetworkLineJore4Id(value);
        return this;
    }

    @Override
    public NetworkLinesWithHistoryRecord value7(String value) {
        setNetworkLineTypeOfLine(value);
        return this;
    }

    @Override
    public NetworkLinesWithHistoryRecord value8(String value) {
        setNetworkLineLegacyHslMunicipalityCode(value);
        return this;
    }

    @Override
    public NetworkLinesWithHistoryRecord value9(String value) {
        setNetworkLineExportId(value);
        return this;
    }

    @Override
    public NetworkLinesWithHistoryRecord values(UUID value1, String value2, String value3, String value4, TimeRange value5, UUID value6, String value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkLinesWithHistoryRecord(UUID networkLineId, String networkLineExtId, String networkLineNumber, String infrastructureNetworkType, TimeRange networkLineSysPeriod, UUID networkLineJore4Id, String networkLineTypeOfLine, String networkLineLegacyHslMunicipalityCode, String networkLineExportId) {
        super(NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY);
