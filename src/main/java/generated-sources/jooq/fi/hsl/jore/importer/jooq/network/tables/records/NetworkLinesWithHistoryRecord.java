...
public class NetworkLinesWithHistoryRecord extends TableRecordImpl<NetworkLinesWithHistoryRecord> implements Record6<UUID, String, String, String, TimeRange, UUID> {
    ...
    /**
     * Setter for <code>network.network_lines_with_history.network_line_transmodel_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_lines_with_history.network_line_transmodel_id</code>.
     */
    ...
    @Override
    public NetworkLinesWithHistoryRecord values(UUID value1, String value2, String value3, String value4, TimeRange value5, UUID value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkLinesWithHistoryRecord(UUID networkLineId, String networkLineExtId, String networkLineNumber, String infrastructureNetworkType, TimeRange networkLineSysPeriod, UUID networkLineTransmodelId) {
        super(NetworkLinesWithHistory.NETWORK_LINES_WITH_HISTORY);
