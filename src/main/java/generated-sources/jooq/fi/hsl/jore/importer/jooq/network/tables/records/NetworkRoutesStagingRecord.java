...
public class NetworkRoutesStagingRecord extends UpdatableRecordImpl<NetworkRoutesStagingRecord> implements Record5<String, String, String, JSONB, Short> {
    ...
    @Override
    public Row5<String, String, String, JSONB, Short> valuesRow() {
    ...
    @Override
    public NetworkRoutesStagingRecord values(String value1, String value2, String value3, JSONB value4, Short value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkRoutesStagingRecord(String networkRouteExtId, String networkLineExtId, String networkRouteNumber, JSONB networkRouteName, Short networkRouteHiddenVariant) {
        super(NetworkRoutesStaging.NETWORK_ROUTES_STAGING);
