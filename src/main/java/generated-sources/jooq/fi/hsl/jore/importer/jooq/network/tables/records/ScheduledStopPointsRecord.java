...
public class ScheduledStopPointsRecord extends UpdatableRecordImpl<ScheduledStopPointsRecord> implements Record10<UUID, String, UUID, Long, JSONB, TimeRange, String, UUID, Integer, UUID> {
    ...
    public Field<UUID> field10() {
        return ScheduledStopPoints.SCHEDULED_STOP_POINTS.NETWORK_PLACE_ID;
    }
    ...
    @Override
    public ScheduledStopPointsRecord value10(UUID value) {
        setNetworkPlaceId(value);
        return this;
    }

    @Override
    public ScheduledStopPointsRecord values(UUID value1, String value2, UUID value3, Long value4, JSONB value5, TimeRange value6, String value7, UUID value8, Integer value9, UUID value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
