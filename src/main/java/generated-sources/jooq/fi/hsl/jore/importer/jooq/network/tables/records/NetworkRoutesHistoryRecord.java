...
public class NetworkRoutesHistoryRecord extends TableRecordImpl<NetworkRoutesHistoryRecord> implements Record7<UUID, UUID, String, String, JSONB, TimeRange, UUID> {
    ...
    @Override
    public NetworkRoutesHistoryRecord values(UUID value1, UUID value2, String value3, String value4, JSONB value5, TimeRange value6, UUID value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkRoutesHistoryRecord(UUID networkRouteId, UUID networkLineId, String networkRouteExtId, String networkRouteNumber, JSONB networkRouteName, TimeRange networkRouteSysPeriod, UUID networkRouteTransmodelId) {
        super(NetworkRoutesHistory.NETWORK_ROUTES_HISTORY);
