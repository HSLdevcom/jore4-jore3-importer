...
public class NetworkRoutesHistoryRecord extends TableRecordImpl<NetworkRoutesHistoryRecord> implements Record8<UUID, UUID, String, String, JSONB, TimeRange, UUID, UUID> {
    ...
    /**
     * Setter for <code>network.network_routes_history.network_route_transmodel_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_history.network_route_transmodel_id</code>.
     */
    ...
    /**
     * Setter for <code>network.network_routes_history.journey_pattern_transmodel_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_history.journey_pattern_transmodel_id</code>.
     */
    ...
    public Field<UUID> field7() {
        return NetworkRoutesHistory.NETWORK_ROUTES_HISTORY.NETWORK_ROUTE_TRANSMODEL_ID;
    }

    @Override
    public Field<UUID> field8() {
        return NetworkRoutesHistory.NETWORK_ROUTES_HISTORY.JOURNEY_PATTERN_TRANSMODEL_ID;
    }
    ...
    @Override
    public NetworkRoutesHistoryRecord value7(UUID value) {
        setNetworkRouteTransmodelId(value);
        return this;
    }

    @Override
    public NetworkRoutesHistoryRecord value8(UUID value) {
        setJourneyPatternTransmodelId(value);
        return this;
    }

    @Override
    public NetworkRoutesHistoryRecord values(UUID value1, UUID value2, String value3, String value4, JSONB value5, TimeRange value6, UUID value7, UUID value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkRoutesHistoryRecord(UUID networkRouteId, UUID networkLineId, String networkRouteExtId, String networkRouteNumber, JSONB networkRouteName, TimeRange networkRouteSysPeriod, UUID networkRouteTransmodelId, UUID journeyPatternTransmodelId) {
        super(NetworkRoutesHistory.NETWORK_ROUTES_HISTORY);
