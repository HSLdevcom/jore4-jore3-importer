...
public class NetworkLinesHistoryRecord extends TableRecordImpl<NetworkLinesHistoryRecord> implements Record6<UUID, String, String, String, TimeRange, UUID> {
    ...
    @Override
    public NetworkLinesHistoryRecord values(UUID value1, String value2, String value3, String value4, TimeRange value5, UUID value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkLinesHistoryRecord(UUID networkLineId, String networkLineExtId, String networkLineNumber, String infrastructureNetworkType, TimeRange networkLineSysPeriod, UUID networkLineTransmodelId) {
        super(NetworkLinesHistory.NETWORK_LINES_HISTORY);
