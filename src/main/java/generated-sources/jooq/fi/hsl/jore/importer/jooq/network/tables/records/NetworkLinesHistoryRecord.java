...
public class NetworkLinesHistoryRecord extends TableRecordImpl<NetworkLinesHistoryRecord> implements Record5<UUID, String, String, String, TimeRange> {
    ...
    @Override
    public NetworkLinesHistoryRecord values(UUID value1, String value2, String value3, String value4, TimeRange value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkLinesHistoryRecord(UUID networkLineId, String networkLineExtId, String networkLineNumber, String infrastructureNetworkType, TimeRange networkLineSysPeriod) {
        super(NetworkLinesHistory.NETWORK_LINES_HISTORY);
