...
public class NetworkRouteStopPointsHistoryRecord extends TableRecordImpl<NetworkRouteStopPointsHistoryRecord> implements Record8<UUID, String, Integer, Boolean, Integer, TimeRange, Boolean, JSONB> {
    ...
    @Override
    public NetworkRouteStopPointsHistoryRecord values(UUID value1, String value2, Integer value3, Boolean value4, Integer value5, TimeRange value6, Boolean value7, JSONB value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
