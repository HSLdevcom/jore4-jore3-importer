...
public class InsertScheduledStopPointWithVehicleMode2 extends AbstractRoutine<java.lang.Void> {
    ...
    /**
     * The parameter
     * <code>internal_service_pattern.insert_scheduled_stop_point_with_vehicle_mode.external_id</code>.
     */
    public static final Parameter<Integer> EXTERNAL_ID = Internal.createParameter("external_id", SQLDataType.INTEGER, false, false);
     ...
     */
    public InsertScheduledStopPointWithVehicleMode2() {
    ...
    /**
     * Set the <code>external_id</code> parameter IN value to the routine
     */
    public void setExternalId(Integer value) {
        setValue(EXTERNAL_ID, value);
    }
