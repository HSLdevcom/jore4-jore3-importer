...
public class NetworkRoutesHistory extends TableImpl<NetworkRoutesHistoryRecord> {
    ...
    /**
     * The column <code>network.network_routes_history.journey_pattern_transmodel_id</code>.
     */
    public final TableField<NetworkRoutesHistoryRecord, UUID> JOURNEY_PATTERN_TRANSMODEL_ID = createField(DSL.name("journey_pattern_transmodel_id"), SQLDataType.UUID, this, "");
