...
public class FindEffectiveScheduledStopPointsInJourneyPattern extends TableImpl<Record> {
    ...
    /**
     * The column
     * <code>network.find_effective_scheduled_stop_points_in_journey_pattern.journey_pattern_id</code>.
     */
    public final TableField<Record, UUID> JOURNEY_PATTERN_ID = createField(DSL.name("journey_pattern_id"), SQLDataType.UUID, this, "");

    /**
     * The column
     * <code>network.find_effective_scheduled_stop_points_in_journey_pattern.scheduled_stop_point_sequence</code>.
     */
    ...
    /**
     * The column
     * <code>network.find_effective_scheduled_stop_points_in_journey_pattern.is_used_as_timing_point</code>.
     */
    ...
    /**
     * The column
     * <code>network.find_effective_scheduled_stop_points_in_journey_pattern.is_loading_time_allowed</code>.
     */
    ...
    /**
     * The column
     * <code>network.find_effective_scheduled_stop_points_in_journey_pattern.is_regulated_timing_point</code>.
     */
    ...
    /**
     * The column
     * <code>network.find_effective_scheduled_stop_points_in_journey_pattern.is_via_point</code>.
     */
    public final TableField<Record, Boolean> IS_VIA_POINT = createField(DSL.name("is_via_point"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column
     * <code>network.find_effective_scheduled_stop_points_in_journey_pattern.via_point_name_i18n</code>.
     */
    public final TableField<Record, JSONB> VIA_POINT_NAME_I18N = createField(DSL.name("via_point_name_i18n"), SQLDataType.JSONB, this, "");

    /**
     * The column
     * <code>network.find_effective_scheduled_stop_points_in_journey_pattern.via_point_short_name_i18n</code>.
     */
    ...
    /**
     * The column
     * <code>network.find_effective_scheduled_stop_points_in_journey_pattern.effective_scheduled_stop_point_id</code>.
     */
