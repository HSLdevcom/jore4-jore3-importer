...
public class InsertScheduledStopPointWithVehicleMode extends AbstractRoutine<java.lang.Void> {
    ...
    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.scheduled_stop_point_id</code>.
     */
    ...
    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.measured_location</code>.
     */
    ...
    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.located_on_infrastructure_link_id</code>.
     */
    ...
    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.direction</code>.
     */
    public static final Parameter<String> DIRECTION = Internal.createParameter("direction", SQLDataType.CLOB, false, false);

    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.label</code>.
     */
    public static final Parameter<String> LABEL = Internal.createParameter("label", SQLDataType.CLOB, false, false);

    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.validity_start</code>.
     */
    ...
    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.validity_end</code>.
     */
    ...
    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.priority</code>.
     */
    public static final Parameter<Integer> PRIORITY = Internal.createParameter("priority", SQLDataType.INTEGER, false, false);

    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.supported_vehicle_mode</code>.
     */
    ...
    /**
     * The parameter
     * <code>network.insert_scheduled_stop_point_with_vehicle_mode.timing_place_id</code>.
     */
    ...
    public InsertScheduledStopPointWithVehicleMode() {
        super("insert_scheduled_stop_point_with_vehicle_mode", Network.NETWORK);
