...
public class Route extends TableImpl<Record> {
    ...
    /**
     * The reference instance of <code>network.route</code>
     */
    ...
    /**
     * The column <code>network.route.route_id</code>. The ID of the route.
     */
    ...
    /**
     * The column <code>network.route.description_i18n</code>. The description
     * of the route in the form of starting location - destination. Placeholder
    ...
    /**
     * The column <code>network.route.on_line_id</code>. The line to which this
     * route belongs.
     */
    ...
    /**
     * The column <code>network.route.validity_start</code>. The point in time
    ...
    /**
     * The column <code>network.route.validity_end</code>. The point in time
    ...
    /**
     * The column <code>network.route.priority</code>. The priority of the route
    ...
    /**
     * The column <code>network.route.label</code>. The label of the route
     * definition.
     */
    ...
    /**
     * The column <code>network.route.direction</code>. The direction of the
     * route definition.
     */
    ...
    /**
     * The column <code>network.route.destination_name_i18n</code>.
     */
    ...
    /**
     * The column <code>network.route.destination_short_name_i18n</code>.
     */
    ...
    /**
     * The column <code>network.route.variant</code>. The variant for route
     * definition.
     */
    ...
    /**
     * The column <code>network.route.unique_label</code>. Derived from label
     * and variant. Routes are unique for each unique label for a certain
     * direction, priority and validity period
     */
    ...
    /**
     * The column <code>network.route.legacy_hsl_municipality_code</code>.
    ...
    /**
     * The column <code>network.route.version_comment</code>. An extra comment
    ...
    /**
     * Create an aliased <code>network.route</code> table reference
     */
    ...
    /**
     * Create a <code>network.route</code> table reference
     */
    public Route() {
