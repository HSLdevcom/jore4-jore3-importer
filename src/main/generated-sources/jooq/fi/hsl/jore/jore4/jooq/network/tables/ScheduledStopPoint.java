...
public class ScheduledStopPoint extends TableImpl<Record> {
    ...
    /**
     * The reference instance of <code>network.scheduled_stop_point</code>
     */
    ...
    /**
     * The column
     * <code>network.scheduled_stop_point.scheduled_stop_point_id</code>. The ID
     * of the scheduled stop point.
     */
    ...
    /**
     * The column <code>network.scheduled_stop_point.measured_location</code>.
     * The measured location describes the physical location of the stop. For
     * some stops this describes the location of the pole-mounted flag. A
     * PostGIS PointZ geography in EPSG:4326.
     */
    ...
    /**
     * The column
     * <code>network.scheduled_stop_point.located_on_infrastructure_link_id</code>.
    ...
    /**
     * The column <code>network.scheduled_stop_point.direction</code>. The
    ...
    /**
     * The column <code>network.scheduled_stop_point.label</code>. The label is
     * the short code that identifies the stop to the passengers. There can be
     * at most one stop with the same label at a time. The label matches the
     * GTFS stop_code.
     */
    ...
    /**
     * The column <code>network.scheduled_stop_point.validity_start</code>.
     * start of the operating date span in the scheduled stop point's local time
     * (inclusive).
     */
    ...
    /**
     * The column <code>network.scheduled_stop_point.validity_end</code>. end of
    ...
    /**
     * The column <code>network.scheduled_stop_point.priority</code>.
     */
    public final TableField<Record, Integer> PRIORITY = createField(DSL.name("priority"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>network.scheduled_stop_point.timing_place_id</code>.
    ...
    /**
     * The column <code>network.scheduled_stop_point.stop_place_ref</code>. The
     * id of the related stop place in stop registry schema.
     */
    public final TableField<Record, String> STOP_PLACE_REF = createField(DSL.name("stop_place_ref"), SQLDataType.CLOB, this, "The id of the related stop place in stop registry schema.");
    ...
    /**
     * Create an aliased <code>network.scheduled_stop_point</code> table
     * reference
     */
    ...
    /**
     * Create a <code>network.scheduled_stop_point</code> table reference
     */
