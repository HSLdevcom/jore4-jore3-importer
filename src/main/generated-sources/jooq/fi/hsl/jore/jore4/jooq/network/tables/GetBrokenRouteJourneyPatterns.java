 ...
 * NULL::uuid, new_located_on_infrastructure_link_id uuid DEFAULT NULL::uuid,
...
public class GetBrokenRouteJourneyPatterns extends TableImpl<Record> {
     ...
     * <code>network.get_broken_route_journey_patterns</code>
     */
    ...
    /**
     * The column
     * <code>network.get_broken_route_journey_patterns.journey_pattern_id</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_broken_route_journey_patterns.on_route_id</code>.
     */
    ...
    private GetBrokenRouteJourneyPatterns(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("filter_route_ids uuid[], replace_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_located_on_infrastructure_link_id uuid DEFAULT NULL::uuid, new_measured_location geography DEFAULT NULL::geography, new_direction text DEFAULT NULL::text, new_label text DEFAULT NULL::text, new_validity_start date DEFAULT NULL::date, new_validity_end date DEFAULT NULL::date, new_priority integer DEFAULT NULL::integer"), TableOptions.function(), where);
    }

    /**
     * Create an aliased <code>network.get_broken_route_journey_patterns</code>
     * table reference
     */
    ...
    /**
     * Create a <code>network.get_broken_route_journey_patterns</code> table
     * reference
     */
