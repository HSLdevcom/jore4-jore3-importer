...
/**
 * journey_pattern_id uuid, observation_date date, include_draft_stops boolean
 */
...
public class GetDistancesBetweenStopPointsInJourneyPattern extends TableImpl<Record> {
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_in_journey_pattern.journey_pattern_id</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_in_journey_pattern.route_id</code>.
     */
    public final TableField<Record, UUID> ROUTE_ID = createField(DSL.name("route_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column
     * <code>network.get_distances_between_stop_points_in_journey_pattern.route_priority</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_in_journey_pattern.observation_date</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_in_journey_pattern.stop_interval_sequence</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_in_journey_pattern.start_stop_label</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_in_journey_pattern.end_stop_label</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_in_journey_pattern.distance_in_metres</code>.
     */
    ...
    private GetDistancesBetweenStopPointsInJourneyPattern(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("journey_pattern_id uuid, observation_date date, include_draft_stops boolean"), TableOptions.function(), where);
    }
