...
public class GetDistancesBetweenStopPointsByRoutes extends TableImpl<Record> {
     ...
     * <code>network.get_distances_between_stop_points_by_routes</code>
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_by_routes.journey_pattern_id</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_by_routes.route_id</code>.
     */
    public final TableField<Record, UUID> ROUTE_ID = createField(DSL.name("route_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column
     * <code>network.get_distances_between_stop_points_by_routes.route_priority</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_by_routes.observation_date</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_by_routes.stop_interval_sequence</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_by_routes.start_stop_label</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_by_routes.end_stop_label</code>.
     */
    ...
    /**
     * The column
     * <code>network.get_distances_between_stop_points_by_routes.distance_in_metres</code>.
     */
    ...
    private GetDistancesBetweenStopPointsByRoutes(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("route_ids uuid[], observation_date date"), TableOptions.function(), where);
    }

    /**
     * Create an aliased
     * <code>network.get_distances_between_stop_points_by_routes</code> table
     * reference
     */
    ...
    /**
     * Create a <code>network.get_distances_between_stop_points_by_routes</code>
     * table reference
     */
