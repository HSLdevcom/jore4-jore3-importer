...
public class JourneyPattern extends TableImpl<Record> {
    ...
    /**
     * The reference instance of <code>network.journey_pattern</code>
     */
    ...
    /**
     * The column <code>network.journey_pattern.journey_pattern_id</code>. The
    ...
    /**
     * The column <code>network.journey_pattern.on_route_id</code>. The ID of
     * the route the journey pattern is on.
     */
    ...
    /**
     * Create an aliased <code>network.journey_pattern</code> table reference
     */
    public JourneyPattern(String alias) {
        this(DSL.name(alias), JOURNEY_PATTERN);
    }
    ...
    public JourneyPattern(Name alias) {
        this(alias, JOURNEY_PATTERN);
    }

    /**
     * Create a <code>network.journey_pattern</code> table reference
     */
