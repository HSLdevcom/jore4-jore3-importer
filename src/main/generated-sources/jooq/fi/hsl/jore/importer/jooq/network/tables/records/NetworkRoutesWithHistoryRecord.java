...
public class NetworkRoutesWithHistoryRecord extends TableRecordImpl<NetworkRoutesWithHistoryRecord> implements Record8<UUID, UUID, String, String, JSONB, TimeRange, Short, String> {

    private static final long serialVersionUID = 1L;

    /**
     * Setter for <code>network.network_routes_with_history.network_route_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.network_route_id</code>.
     */
    ...
    /**
     * Setter for <code>network.network_routes_with_history.network_line_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.network_line_id</code>.
     */
    ...
    /**
     * Setter for <code>network.network_routes_with_history.network_route_ext_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.network_route_ext_id</code>.
     */
    ...
    /**
     * Setter for <code>network.network_routes_with_history.network_route_number</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.network_route_number</code>.
     */
    ...
    /**
     * Setter for <code>network.network_routes_with_history.network_route_name</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.network_route_name</code>.
     */
    ...
    /**
     * Setter for <code>network.network_routes_with_history.network_route_sys_period</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.network_route_sys_period</code>.
     */
    ...
    /**
     * Setter for <code>network.network_routes_with_history.network_route_hidden_variant</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.network_route_hidden_variant</code>.
     */
    ...
    /**
     * Setter for <code>network.network_routes_with_history.network_route_legacy_hsl_municipality_code</code>.
     */
    ...
    /**
     * Getter for <code>network.network_routes_with_history.network_route_legacy_hsl_municipality_code</code>.
     */
    ...
    public Field<Short> field7() {
        return NetworkRoutesWithHistory.NETWORK_ROUTES_WITH_HISTORY.NETWORK_ROUTE_HIDDEN_VARIANT;
    }

    @Override
    public Field<String> field8() {
        return NetworkRoutesWithHistory.NETWORK_ROUTES_WITH_HISTORY.NETWORK_ROUTE_LEGACY_HSL_MUNICIPALITY_CODE;
    }
    ...
    @Override
    public NetworkRoutesWithHistoryRecord value7(Short value) {
        setNetworkRouteHiddenVariant(value);
        return this;
    }

    @Override
    public NetworkRoutesWithHistoryRecord value8(String value) {
        setNetworkRouteLegacyHslMunicipalityCode(value);
        return this;
    }

    @Override
    public NetworkRoutesWithHistoryRecord values(UUID value1, UUID value2, String value3, String value4, JSONB value5, TimeRange value6, Short value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
