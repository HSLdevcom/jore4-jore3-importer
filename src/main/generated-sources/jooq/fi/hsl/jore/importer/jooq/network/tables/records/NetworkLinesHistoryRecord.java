...
public class NetworkLinesHistoryRecord extends TableRecordImpl<NetworkLinesHistoryRecord> implements Record8<UUID, String, String, String, TimeRange, UUID, String, String> {
    ...
    /**
     * Setter for <code>network.network_lines_history.network_line_jore4_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_lines_history.network_line_jore4_id</code>.
     */
    ...
    @Override
    public NetworkLinesHistoryRecord values(UUID value1, String value2, String value3, String value4, TimeRange value5, UUID value6, String value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NetworkLinesHistoryRecord(UUID networkLineId, String networkLineExtId, String networkLineNumber, String infrastructureNetworkType, TimeRange networkLineSysPeriod, UUID networkLineJore4Id, String networkLineTypeOfLine, String networkLineLegacyHslMunicipalityCode) {
        super(NetworkLinesHistory.NETWORK_LINES_HISTORY);
