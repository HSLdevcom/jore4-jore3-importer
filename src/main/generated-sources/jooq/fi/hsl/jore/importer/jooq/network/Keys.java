...
public class Keys {
    ...
    public static final ForeignKey<ScheduledStopPointsRecord, NetworkPlacesRecord> SCHEDULED_STOP_POINTS__SCHEDULED_STOP_POINTS_NETWORK_PLACE_ID_FKEY = Internal.createForeignKey(ScheduledStopPoints.SCHEDULED_STOP_POINTS, DSL.name("scheduled_stop_points_network_place_id_fkey"), new TableField[] { ScheduledStopPoints.SCHEDULED_STOP_POINTS.NETWORK_PLACE_ID }, Keys.NETWORK_PLACES_PKEY, new TableField[] { NetworkPlaces.NETWORK_PLACES.NETWORK_PLACE_ID }, true);
}
