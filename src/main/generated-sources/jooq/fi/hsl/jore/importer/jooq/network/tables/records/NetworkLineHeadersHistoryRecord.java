...
public class NetworkLineHeadersHistoryRecord extends TableRecordImpl<NetworkLineHeadersHistoryRecord> implements Record10<UUID, UUID, String, JSONB, JSONB, JSONB, JSONB, DateRange, TimeRange, UUID> {
    ...
    /**
     * Setter for <code>network.network_line_headers_history.jore4_line_id</code>.
     */
    ...
    /**
     * Getter for <code>network.network_line_headers_history.jore4_line_id</code>.
     */
    ...
    public Field<UUID> field10() {
        return NetworkLineHeadersHistory.NETWORK_LINE_HEADERS_HISTORY.JORE4_LINE_ID;
    }
    ...
    @Override
    public NetworkLineHeadersHistoryRecord value10(UUID value) {
        setJore4LineId(value);
        return this;
    }

    @Override
    public NetworkLineHeadersHistoryRecord values(UUID value1, UUID value2, String value3, JSONB value4, JSONB value5, JSONB value6, JSONB value7, DateRange value8, TimeRange value9, UUID value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
